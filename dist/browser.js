...
const yn = { randomUUID: typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto) };
function li(e, A, t) {
  if (yn.randomUUID && !A && !e)
...
const { toString: ui } = Object.prototype, { getPrototypeOf: cn } = Object, Ot = (gr = /* @__PURE__ */ Object.create(null), (e) => {
  const A = ui.call(e);
  return gr[A] || (gr[A] = A.slice(8, -1).toLowerCase());
});
var gr;
const jA = (e) => (e = e.toLowerCase(), (A) => Ot(A) === e), tr = (e) => (A) => typeof A === e, { isArray: be } = Array, Re = tr("undefined"), En = jA("ArrayBuffer"), gi = tr("string"), KA = tr("function"), bn = tr("number"), at = (e) => e !== null && typeof e == "object", ct = (e) => {
  if (Ot(e) !== "object")
    return !1;
  const A = cn(e);
  return !(A !== null && A !== Object.prototype && Object.getPrototypeOf(A) !== null || Symbol.toStringTag in e || Symbol.iterator in e);
}, wi = jA("Date"), hi = jA("File"), Qi = jA("Blob"), pi = jA("FileList"), Ci = jA("URLSearchParams");
...
const _s = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, kn = (e) => !Re(e) && e !== _s, fi = (wr = typeof Uint8Array < "u" && cn(Uint8Array), (e) => wr && e instanceof wr);
var wr;
const Ui = jA("HTMLFormElement"), vn = (({ hasOwnProperty: e }) => (A, t) => e.call(A, t))(Object.prototype), Fi = jA("RegExp"), In = (e, A) => {
  const t = Object.getOwnPropertyDescriptors(e), r = {};
  Ge(t, (n, s) => {
    let o;
    (o = A(n, s, e)) !== !1 && (r[s] = o || n);
  }), Object.defineProperties(e, r);
}, hr = "abcdefghijklmnopqrstuvwxyz", xn = "0123456789", Kn = { DIGIT: xn, ALPHA: hr, ALPHA_DIGIT: hr + hr.toUpperCase() + xn }, mi = jA("AsyncFunction"), Q = { isArray: be, isArrayBuffer: En, isBuffer: function(e) {
  return e !== null && !Re(e) && e.constructor !== null && !Re(e.constructor) && KA(e.constructor.isBuffer) && e.constructor.isBuffer(e);
}, isFormData: (e) => {
  let A;
  return e && (typeof FormData == "function" && e instanceof FormData || KA(e.append) && ((A = Ot(e)) === "formdata" || A === "object" && KA(e.toString) && e.toString() === "[object FormData]"));
}, isArrayBufferView: function(e) {
  let A;
  return A = typeof ArrayBuffer < "u" && ArrayBuffer.isView ? ArrayBuffer.isView(e) : e && e.buffer && En(e.buffer), A;
}, isString: gi, isNumber: bn, isBoolean: (e) => e === !0 || e === !1, isObject: at, isPlainObject: ct, isUndefined: Re, isDate: wi, isFile: hi, isBlob: Qi, isRegExp: Fi, isFunction: KA, isStream: (e) => at(e) && KA(e.pipe), isURLSearchParams: Ci, isTypedArray: fi, isFileList: pi, forEach: Ge, merge: function e() {
  const { caseless: A } = kn(this) && this || {}, t = {}, r = (n, s) => {
    const o = A && Hn(t, s) || s;
    ct(t[o]) && ct(n) ? t[o] = e(t[o], n) : ct(n) ? t[o] = e({}, n) : be(n) ? t[o] = n.slice() : t[o] = n;
  };
  for (let n = 0, s = arguments.length; n < s; n++)
    arguments[n] && Ge(arguments[n], r);
  return t;
}, extend: (e, A, t, { allOwnKeys: r } = {}) => (Ge(A, (n, s) => {
  t && KA(n) ? e[s] = Ps(n, t) : e[s] = n;
  ...
  return A;
}, kindOf: Ot, kindOfTest: jA, endsWith: (e, A, t) => {
  ...
  for (; (t = e.exec(A)) !== null; )
    r.push(t);
  return r;
}, isHTMLForm: Ui, hasOwnProperty: vn, hasOwnProp: vn, reduceDescriptors: In, freezeMethods: (e) => {
  In(e, (A, t) => {
...
}, toFiniteNumber: (e, A) => (e = +e, Number.isFinite(e) ? e : A), findKey: Hn, global: _s, isContextDefined: kn, ALPHABET: Kn, generateString: (e = 16, A = Kn.ALPHA_DIGIT) => {
  let t = "";
  const { length: r } = A;
  for (; e--; )
    t += A[Math.random() * r | 0];
  ...
  return t(e, 0);
}, isAsyncFn: mi, isThenable: (e) => e && (at(e) || KA(e)) && KA(e.then) && KA(e.catch) };
...
const Ln = K.prototype, Sn = {};
["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((e) => {
  Sn[e] = { value: e };
}), Object.defineProperties(K, Sn), Object.defineProperty(Ln, "isAxiosError", { value: !0 }), K.from = (e, A, t, r, n, s) => {
  ...
  function B(d, g, u) {
    ...
    if (d && !u && typeof d == "object") {
      if (Q.endsWith(g, "{}"))
        ...
        return g = Ns(g), w.forEach(function(h, p) {
          !Q.isUndefined(h) && h !== null && A.append(o === !0 ? Dn([g], p, s) : o === null ? g : g + "[]", c(h));
        }), !1;
    }
    return !!Qr(d) || (A.append(Dn(u, g, s), c(d)), !1);
  }
...
function Bn(e, A) {
  this._pairs = [], e && Mt(e, this, A);
}
const On = Bn.prototype;
function Ei(e) {
...
const Js = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 }, bi = { isBrowser: !0, classes: { URLSearchParams: typeof URLSearchParams < "u" ? URLSearchParams : Bn, FormData: typeof FormData < "u" ? FormData : null, Blob: typeof Blob < "u" ? Blob : null }, protocols: ["http", "https", "file", "blob", "url", "data"] }, Ys = typeof window < "u" && typeof document < "u", Hi = (Rn = typeof navigator < "u" && navigator.product, Ys && ["ReactNative", "NativeScript", "NS"].indexOf(Rn) < 0);
var Rn;
const ki = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function", YA = { ...Object.freeze(Object.defineProperty({ __proto__: null, hasBrowserEnv: Ys, hasStandardBrowserEnv: Hi, hasStandardBrowserWebWorkerEnv: ki }, Symbol.toStringTag, { value: "Module" })), ...bi };
function Ws(e) {
  function A(t, r, n, s) {
    let o = t[s++];
    if (o === "__proto__")
...
const ln = { transitional: Js, adapter: ["xhr", "http"], transformRequest: [function(e, A) {
  ...
  if (n && Q.isHTMLForm(e) && (e = new FormData(e)), Q.isFormData(e))
    return r && r ? JSON.stringify(Ws(e)) : e;
  ...
  if (n) {
    if (t.indexOf("application/x-www-form-urlencoded") > -1)
      return function(o, i) {
        return Mt(o, new YA.classes.URLSearchParams(), Object.assign({ visitor: function(c, B, a, l) {
          return YA.isNode && Q.isBuffer(c) ? (this.append(B, c.toString("base64")), !1) : l.defaultVisitor.apply(this, arguments);
        } }, i));
      }(e, this.formSerializer).toString();
    if ((s = Q.isFileList(e)) || t.indexOf("multipart/form-data") > -1) {
      const o = this.env && this.env.FormData;
      return Mt(s ? { "files[]": e } : e, o && new o(), this.formSerializer);
    }
  }
  ...
  return e;
}], timeout: 0, xsrfCookieName: "XSRF-TOKEN", xsrfHeaderName: "X-XSRF-TOKEN", maxContentLength: -1, maxBodyLength: -1, env: { FormData: YA.classes.FormData, Blob: YA.classes.Blob }, validateStatus: function(e) {
  return e >= 200 && e < 300;
}, headers: { common: { Accept: "application/json, text/plain, */*", "Content-Type": void 0 } } };
Q.forEach(["delete", "get", "head", "post", "put", "patch"], (e) => {
  ln.headers[e] = {};
});
const dn = ln, vi = Q.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]), Gn = Symbol("internals");
function Te(e) {
  return e && String(e).trim().toLowerCase();
}
function vt(e) {
  return e === !1 || e == null ? e : Q.isArray(e) ? e.map(vt) : String(e);
}
...
class It {
  ...
  set(A, t, r) {
    ...
    function s(i, c, B) {
      ...
      (!l || n[l] === void 0 || B === !0 || B === void 0 && n[l] !== !1) && (n[l || c] = vt(i));
    }
...
`);
  ...
  static accessor(A) {
    const t = (this[Gn] = this[Gn] = { accessors: {} }).accessors, r = this.prototype;
    function n(s) {
      const o = Te(s);
      t[o] || (function(i, c) {
...
const re = It;
function Cr(e, A) {
  const t = this || dn, r = A || t, n = re.from(r.headers);
  let s = r.data;
...
const Ii = YA.hasStandardBrowserEnv ? { write(e, A, t, r, n, s) {
...
const xi = YA.hasStandardBrowserEnv ? function() {
...
const qs = { http: null, xhr: typeof XMLHttpRequest < "u" && function(e) {
  return new Promise(function(A, t) {
    let r = e.data;
    const n = re.from(e.headers).normalize();
    let s, o, { responseType: i, withXSRFToken: c } = e;
    function B() {
      e.cancelToken && e.cancelToken.unsubscribe(s), e.signal && e.signal.removeEventListener("abort", s);
    }
    if (Q.isFormData(r)) {
      if (YA.hasStandardBrowserEnv || YA.hasStandardBrowserWebWorkerEnv)
        n.setContentType(!1);
    ...
    function d() {
      if (!a)
        return;
      const u = re.from("getAllResponseHeaders" in a && a.getAllResponseHeaders());
      (function(w, h, p) {
    ...
    if (a.open(e.method.toUpperCase(), Xs(l, e.params, e.paramsSerializer), !0), a.timeout = e.timeout, "onloadend" in a ? a.onloadend = d : a.onreadystatechange = function() {
    ...
    }), Q.isUndefined(e.withCredentials) || (a.withCredentials = !!e.withCredentials), i && i !== "json" && (a.responseType = e.responseType), typeof e.onDownloadProgress == "function" && a.addEventListener("progress", Vn(e.onDownloadProgress, !0)), typeof e.onUploadProgress == "function" && a.upload && a.upload.addEventListener("progress", Vn(e.onUploadProgress)), (e.cancelToken || e.signal) && (s = (u) => {
    ...
    g && YA.protocols.indexOf(g) === -1 ? t(new K("Unsupported protocol " + g + ":", K.ERR_BAD_REQUEST, e)) : a.send(r || null);
  });
} };
Q.forEach(qs, (e, A) => {
  if (e) {
...
const Pn = (e) => `- ${e}`, Ki = (e) => Q.isFunction(e) || e === null || e === !1, zs = (e) => {
  e = Q.isArray(e) ? e : [e];
  const { length: A } = e;
  let t, r;
  const n = {};
  for (let s = 0; s < A; s++) {
    let o;
    if (t = e[s], r = t, !Ki(t) && (r = qs[(o = String(t)).toLowerCase()], r === void 0))
...
` + s.map(Pn).join(`
`) : " " + Pn(s[0]) : "as no adapter specified"), "ERR_NOT_SUPPORT");
  }
  return r;
};
function fr(e) {
...
function _n(e) {
  return fr(e), e.headers = re.from(e.headers), e.data = Cr.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), zs(e.adapter || dn.adapter)(e).then(function(A) {
    return fr(e), A.data = Cr.call(e, e.transformResponse, A), A.headers = re.from(A.headers), A;
  }, function(A) {
    return js(A) || (fr(e), A && A.response && (A.response.data = Cr.call(e, e.transformResponse, A.response), A.response.headers = re.from(A.response.headers))), Promise.reject(A);
  });
}
const Nn = (e) => e instanceof re ? e.toJSON() : e;
function Se(e, A) {
  A = A || {};
  const t = {};
  function r(B, a, l) {
...
un.transitional = function(e, A, t) {
  ...
  return (n, s, o) => {
    ...
    return A && !Xn[s] && (Xn[s] = !0, console.warn(r(s, " has been deprecated since v" + A + " and will be removed in the near future"))), !e || e(n, s, o);
  };
};
const Lr = { assertOptions: function(e, A, t) {
  if (typeof e != "object")
...
}, validators: un }, oe = Lr.validators;
class xt {
  constructor(A) {
    this.defaults = A, this.interceptors = { request: new Mn(), response: new Mn() };
  }
  async request(A, t) {
    try {
...
` + n.stack), r;
  ...
  _request(A, t) {
    typeof A == "string" ? (t = t || {}).url = A : t = A || {}, t = Se(this.defaults, t);
    const { transitional: r, paramsSerializer: n, headers: s } = t;
    r !== void 0 && Lr.assertOptions(r, { silentJSONParsing: oe.transitional(oe.boolean), forcedJSONParsing: oe.transitional(oe.boolean), clarifyTimeoutError: oe.transitional(oe.boolean) }, !1), n != null && (Q.isFunction(n) ? t.paramsSerializer = { serialize: n } : Lr.assertOptions(n, { encode: oe.function, serialize: oe.function }, !0)), t.method = (t.method || this.defaults.method || "get").toLowerCase();
  ...
  getUri(A) {
    return Xs(Zs((A = Se(this.defaults, A)).baseURL, A.url), A.params, A.paramsSerializer);
  }
}
Q.forEach(["delete", "get", "head", "options"], function(e) {
  xt.prototype[e] = function(A, t) {
    return this.request(Se(t || {}, { method: e, url: A, data: (t || {}).data }));
  };
}), Q.forEach(["post", "put", "patch"], function(e) {
  function A(t) {
    return function(r, n, s) {
      return this.request(Se(s || {}, { method: e, headers: t ? { "Content-Type": "multipart/form-data" } : {}, url: r, data: n }));
    };
  }
  xt.prototype[e] = A(), xt.prototype[e + "Form"] = A(!0);
});
const Kt = xt;
class gn {
  constructor(A) {
...
const Si = gn, Sr = { Continue: 100, SwitchingProtocols: 101, Processing: 102, EarlyHints: 103, Ok: 200, Created: 201, Accepted: 202, NonAuthoritativeInformation: 203, NoContent: 204, ResetContent: 205, PartialContent: 206, MultiStatus: 207, AlreadyReported: 208, ImUsed: 226, MultipleChoices: 300, MovedPermanently: 301, Found: 302, SeeOther: 303, NotModified: 304, UseProxy: 305, Unused: 306, TemporaryRedirect: 307, PermanentRedirect: 308, BadRequest: 400, Unauthorized: 401, PaymentRequired: 402, Forbidden: 403, NotFound: 404, MethodNotAllowed: 405, NotAcceptable: 406, ProxyAuthenticationRequired: 407, RequestTimeout: 408, Conflict: 409, Gone: 410, LengthRequired: 411, PreconditionFailed: 412, PayloadTooLarge: 413, UriTooLong: 414, UnsupportedMediaType: 415, RangeNotSatisfiable: 416, ExpectationFailed: 417, ImATeapot: 418, MisdirectedRequest: 421, UnprocessableEntity: 422, Locked: 423, FailedDependency: 424, TooEarly: 425, UpgradeRequired: 426, PreconditionRequired: 428, TooManyRequests: 429, RequestHeaderFieldsTooLarge: 431, UnavailableForLegalReasons: 451, InternalServerError: 500, NotImplemented: 501, BadGateway: 502, ServiceUnavailable: 503, GatewayTimeout: 504, HttpVersionNotSupported: 505, VariantAlsoNegotiates: 506, InsufficientStorage: 507, LoopDetected: 508, NotExtended: 510, NetworkAuthenticationRequired: 511 };
Object.entries(Sr).forEach(([e, A]) => {
  Sr[A] = e;
});
const Di = Sr, j = function e(A) {
  const t = new Kt(A), r = Ps(Kt.prototype.request, t);
  return Q.extend(r, Kt.prototype, t, { allOwnKeys: !0 }), Q.extend(r, t, null, { allOwnKeys: !0 }), r.create = function(n) {
    return e(Se(A, n));
  }, r;
}(dn);
j.Axios = Kt, j.CanceledError = nt, j.CancelToken = Si, j.isCancel = js, j.VERSION = Li, j.toFormData = Mt, j.AxiosError = K, j.Cancel = j.CanceledError, j.all = function(e) {
...
}, j.mergeConfig = Se, j.AxiosHeaders = re, j.formToJSON = (e) => Ws(Q.isHTMLForm(e) ? new FormData(e) : e), j.getAdapter = zs, j.HttpStatusCode = Di, j.default = j;
var Ti = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Oi(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
const Mi = Oi(typeof self == "object" ? self.FormData : window.FormData), JA = "shake.sdk.appToken", Jn = "shake.sdk.isAppRegistered", Yn = "shake.sdk.isAppActive", Wn = "shake.sdk.isShakeOpened", jn = "shake.sdk.shakeState", Zn = "shake.sdk.shakeDeviceId", he = class he {
  constructor(A, t, r, n) {
    F(this, "instance");
    F(this, "instanceAuth");
    F(this, "version");
    ...
    F(this, "handlers", {});
    j.defaults.withCredentials = !1, this.storageProvider = A, this.bundleId = r, this.deviceId = n, this.version = t, this.instance = j.create({ baseURL: ur.apiHost }), this.instanceAuth = j.create({ baseURL: ur.oAuthHost }), this.setRequestInterceptors(), this.setResponseInterceptors();
  }
...
let $e = he;
var $s = ((e) => (e.WEB = "Web", e))($s || {}), Rt = ((e) => (e.WEB = "Web", e))(Rt || {}), Ye = ((e) => (e.SUGGESTION = "improvement", e.BUG = "bug", e.QUESTION = "question", e))(Ye || {}), Ao = ((e) => (e.MANUAL = "manual", e.AUTOMATIC = "automatic", e))(Ao || {}), Gt = ((e) => (e.TITLE = "title", e.TEXT_INPUT = "text_input", e.EMAIL = "email", e.PICKER = "picker", e))(Gt || {});
const Ri = ["geolocation", "camera", "microphone", "notifications", "persistent-storage", "screen-wake-lock"];
class Gi {
  constructor() {
    F(this, "ticket", null);
    F(this, "description", "");
    F(this, "feedbackType", Ye.BUG);
  }
}
class Vi {
  constructor(A) {
    ...
    F(this, "isAppRegistered", () => this.storageProvider.getBoolean(Jn));
    F(this, "setAppRegistered", (A) => this.storageProvider.setBoolean(Jn, A));
    F(this, "isAppActive", () => this.storageProvider.getBoolean(Yn));
    F(this, "setAppActive", (A) => this.storageProvider.setBoolean(Yn, A));
    F(this, "isShakeOpened", () => this.storageProvider.getBoolean(Wn) ?? !1);
    F(this, "setShakeOpened", (A) => this.storageProvider.setBoolean(Wn, A));
    F(this, "getShakeState", () => this.storageProvider.getObject(jn) ?? new Gi());
    F(this, "setShakeState", (A) => this.storageProvider.setObject(jn, A));
  ...
  return new Promise((e, A) => {
    ...
    t.onerror = function() {
      ...
      s.onsuccess = function(o) {
        ...
        i ? (r.push({ name: i.value.name, data: i.value.data, type: i.value.type }), i.continue()) : e(r);
      }, s.onerror = function() {
...
F(Ke, "storageProvider", new _i()), F(Ke, "localStorage", new Vi(Ke.storageProvider)), F(Ke, "attachmentsManager", new Pi());
let iA = Ke;
const nr = "shakeSdk: ", J = (e) => {
  console.debug(`${nr} ${e}`);
}, qn = (e) => {
  console.info(`${nr} ${e}`);
}, Ce = (e) => {
...
class Ni {
  constructor() {
    ...
    F(this, "authApi");
    const A = $e.getInstance(iA.storageProvider, wn, TA.bundleId, this.data.getShakeDeviceId() ?? "");
  ...
  async registerApp(A) {
    if (!A)
      return !1;
    try {
      return await this.authApi.registerApp(TA.bundleId, Rt.WEB, !1, $s.WEB), !0;
    } catch (t) {
...
class Yi {
  constructor() {
    ...
    F(this, "feedbackApi");
    F(this, "filesApi");
    F(this, "baseApiParams", { storage: iA.storageProvider, version: wn, bundleId: TA.bundleId, deviceId: this.data.getShakeDeviceId() ?? "" });
...
F(De, "shakeAuthService", new Ni()), F(De, "shakeFeedbackService", new Yi());
var Vt = ((e) => (e[e.EN = 0] = "EN", e))(Vt || {});
const to = () => {
...
for (var se = function() {
  ...
  return se.fromClientRect(e, A.getBoundingClientRect());
}, Pt = function(e) {
  ...
  return s;
}, Wi = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", ji = typeof Uint8Array > "u" ? [] : new Uint8Array(256), lt = 0; lt < 64; lt++)
  ji[Wi.charCodeAt(lt)] = lt;
for (var Zi = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Ve = typeof Uint8Array > "u" ? [] : new Uint8Array(256), dt = 0; dt < 64; dt++)
  Ve[Zi.charCodeAt(dt)] = dt;
for (var zn = function(e, A, t) {
...
}(), zi = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", $i = typeof Uint8Array > "u" ? [] : new Uint8Array(256), ut = 0; ut < 64; ut++)
  $i[zi.charCodeAt(ut)] = ut;
var ae = 10, Or = 13, Pe = 15, gt = 17, Oe = 18, Aa = 19, $n = 20, Mr = 21, Me = 22, fe = 24, HA = 25, _e = 26, Ne = 27, Ue = 28, He = 30, wt = 32, ht = 33, Rr = 34, Gr = 35, We = 37, Vr = 38, Lt = 39, St = 40, As = 42, ea = [9001, 65288], x = "×", Qt = "÷", Pr = function(e, A) {
  var t, r, n, s = function(a) {
    var l, d, g, u, w, h = 0.75 * a.length, p = a.length, f = 0;
    a[a.length - 1] === "=" && (h--, a[a.length - 2] === "=" && h--);
    var E = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && Uint8Array.prototype.slice !== void 0 ? new ArrayBuffer(h) : new Array(h), U = Array.isArray(E) ? E : new Uint8Array(E);
    for (l = 0; l < p; l += 4)
  ...
  if (_r.indexOf(c) !== -1)
    return "!";
  if (_r.indexOf(a) !== -1 || so.indexOf(a) !== -1)
    return x;
  if (rs(s, A) === 8)
    return Qt;
  if (Pr.get(e[s]) === 11 || (c === wt || c === ht) && Pr.get(e[i]) === 11 || c === 7 || a === 7 || c === 9 || [ae, Or, Pe].indexOf(c) === -1 && a === 9 || [gt, Oe, Aa, fe, Ue].indexOf(a) !== -1 || rs(s, A) === Me || Ur(23, Me, s, A) || Ur([gt, Oe], Mr, s, A) || Ur(12, 12, s, A))
    return x;
  if (c === ae)
    return Qt;
  if (c === 23 || a === 23)
  ...
  if (a === 16 || c === 16)
    return Qt;
  if ([Or, Pe, Mr].indexOf(a) !== -1 || c === 14 || B === 36 && ra.indexOf(c) !== -1 || c === Ue && a === 36 || a === $n || Ae.indexOf(a) !== -1 && c === HA || Ae.indexOf(c) !== -1 && a === HA || c === Ne && [We, wt, ht].indexOf(a) !== -1 || [We, wt, ht].indexOf(c) !== -1 && a === _e || Ae.indexOf(c) !== -1 && es.indexOf(a) !== -1 || es.indexOf(c) !== -1 && Ae.indexOf(a) !== -1 || [Ne, _e].indexOf(c) !== -1 && (a === HA || [Me, Pe].indexOf(a) !== -1 && A[i + 1] === HA) || [Me, Pe].indexOf(c) !== -1 && a === HA || c === HA && [HA, Ue, fe].indexOf(a) !== -1)
    return x;
  if ([HA, Ue, fe, gt, Oe].indexOf(a) !== -1)
    for (var l = s; l >= 0; ) {
      if ((d = A[l]) === HA)
        return x;
      if ([Ue, fe].indexOf(d) === -1)
        break;
      l--;
    }
  if ([Ne, _e].indexOf(a) !== -1)
    for (l = [gt, Oe].indexOf(c) !== -1 ? o : s; l >= 0; ) {
      var d;
      if ((d = A[l]) === HA)
        return x;
      if ([Ue, fe].indexOf(d) === -1)
  ...
  if (Vr === c && [Vr, Lt, Rr, Gr].indexOf(a) !== -1 || [Lt, Rr].indexOf(c) !== -1 && [Lt, St].indexOf(a) !== -1 || [St, Gr].indexOf(c) !== -1 && a === St || ts.indexOf(c) !== -1 && [$n, _e].indexOf(a) !== -1 || ts.indexOf(a) !== -1 && c === Ne || Ae.indexOf(c) !== -1 && Ae.indexOf(a) !== -1 || c === fe && Ae.indexOf(a) !== -1 || Ae.concat(HA).indexOf(c) !== -1 && a === Me && ea.indexOf(e[i]) === -1 || Ae.concat(HA).indexOf(a) !== -1 && c === Oe)
    return x;
  if (c === 41 && a === 41) {
  ...
  var t = function(i, c) {
    ...
    return i.forEach(function(d, g) {
      ...
      if (u === 4 || u === 11) {
        if (g === 0)
          return a.push(g), B.push(He);
        var w = B[g - 1];
        return ta.indexOf(w) === -1 ? (a.push(a[g - 1]), B.push(w)) : (a.push(g), B.push(He));
      }
      return a.push(g), u === 31 ? B.push(c === "strict" ? Mr : We) : u === As || u === 29 ? B.push(He) : u === 43 ? d >= 131072 && d <= 196605 || d >= 196608 && d <= 262141 ? B.push(We) : B.push(He) : void B.push(u);
    }), [a, B, l];
  }(e, A.lineBreak), r = t[0], n = t[1], s = t[2];
  A.wordBreak !== "break-all" && A.wordBreak !== "break-word" || (n = n.map(function(i) {
    return [HA, He, As].indexOf(i) !== -1 ? We : i;
  }));
  ...
  return e === mA ? _t(A) || ie(A, t) : !!_t(e) || !(e !== 92 || !ie(e, A));
}, Fr = function(e, A, t) {
  ...
  for (var s = []; UA(e[A]); )
    s.push(e[A++]);
  var o = s.length, i = o ? parseInt($.apply(void 0, s), 10) : 0;
  e[A] !== 69 && e[A] !== 101 || A++;
  var c = 1;
  e[A] !== Qe && e[A] !== mA || (e[A] === mA && (c = -1), A++);
  for (var B = []; UA(e[A]); )
    B.push(e[A++]);
  var a = B.length ? parseInt($.apply(void 0, B), 10) : 0;
  return t * (n + i * Math.pow(10, -o)) * Math.pow(10, c * a);
}, ca = { type: 2 }, Ba = { type: 3 }, la = { type: 4 }, da = { type: 13 }, ua = { type: 8 }, ga = { type: 21 }, wa = { type: 9 }, ha = { type: 10 }, Qa = { type: 11 }, pa = { type: 12 }, Ca = { type: 14 }, ft = { type: 23 }, fa = { type: 1 }, Ua = { type: 25 }, Fa = { type: 24 }, ma = { type: 26 }, ya = { type: 27 }, Ea = { type: 28 }, ba = { type: 29 }, Ha = { type: 31 }, Nr = { type: 32 }, oo = function() {
  function e() {
    this._value = [];
  }
  return e.prototype.write = function(A) {
    ...
    switch (A) {
      ...
      case 85:
        ...
        return g !== Qe || !Fe(u) && u !== 63 || (this.consumeCodePoint(), this.consumeUnicodeRangeToken()), this.reconsumeCodePoint(A), this.consumeIdentLikeToken();
      case 124:
        if (this.peekCodePoint(0) === 61)
    ...
    return pt(A) ? (this.consumeWhiteSpace(), Ha) : UA(A) ? (this.reconsumeCodePoint(A), this.consumeNumericToken()) : _t(A) ? (this.reconsumeCodePoint(A), this.consumeIdentLikeToken()) : { type: 6, value: $(A) };
    ...
    if (r)
      return { type: 30, start: parseInt($.apply(void 0, A.map(function(o) {
        return o === 63 ? 48 : o;
      })), 16), end: parseInt($.apply(void 0, A.map(function(o) {
        return o === 63 ? 70 : o;
      })), 16) };
    ...
    if (this.peekCodePoint(0) === mA && Fe(this.peekCodePoint(1))) {
      ...
      return { type: 30, start: n, end: parseInt($.apply(void 0, s), 16) };
    }
    ...
    if (t === 39 || t === 34) {
      ...
      return r.type === 0 && (this.consumeWhiteSpace(), this.peekCodePoint(0) === XA || this.peekCodePoint(0) === 41) ? (this.consumeCodePoint(), { type: 22, value: r.value }) : (this.consumeBadUrlRemnants(), ft);
    }
    for (; ; ) {
      ...
      if (pt(n))
        return this.consumeWhiteSpace(), this.peekCodePoint(0) === XA || this.peekCodePoint(0) === 41 ? (this.consumeCodePoint(), { type: 22, value: $.apply(void 0, A) }) : (this.consumeBadUrlRemnants(), ft);
      if (n === 34 || n === 39 || n === 40 || ia(n))
        return this.consumeBadUrlRemnants(), ft;
      if (n === 92) {
        if (!ie(n, this.peekCodePoint(0)))
          return this.consumeBadUrlRemnants(), ft;
    ...
    for (; ; ) {
      ...
      if (A === 41 || A === XA)
        return;
      ie(A, this.peekCodePoint(0)) && this.consumeEscapedCodePoint();
    }
  }, e.prototype.consumeStringSlice = function(A) {
    for (var t = ""; A > 0; ) {
      var r = Math.min(5e4, A);
      t += $.apply(void 0, this._value.splice(0, r)), A -= r;
    }
    ...
    for (var t = "", r = 0; ; ) {
      ...
      if (n === 92) {
        ...
        s !== XA && s !== void 0 && (s === 10 ? (t += this.consumeStringSlice(r), r = -1, this._value.shift()) : ie(n, s) && (t += this.consumeStringSlice(r), t += $(this.consumeEscapedCodePoint()), r = -1));
      }
      r++;
    }
    ...
    var A = this.consumeCodePoint();
    if (Fe(A)) {
      for (var t = $(A); Fe(this.peekCodePoint(0)) && t.length < 6; )
        t += $(this.consumeCodePoint());
      pt(this.peekCodePoint(0)) && this.consumeCodePoint();
      var r = parseInt(t, 16);
...
}, dA = { type: 17, number: 0, flags: 4 }, Qn = { type: 16, number: 50, flags: 4 }, ce = { type: 16, number: 100, flags: 4 }, Xe = function(e, A, t) {
  var r = e[0], n = e[1];
  ...
  return e.number;
}, co = "grad", Bo = "turn", ot = function(e, A) {
  if (A.type === 15)
    switch (A.unit) {
      case "deg":
  ...
  return e.type === 15 && (e.unit === "deg" || e.unit === co || e.unit === "rad" || e.unit === Bo);
}, uo = function(e) {
  ...
  if (A.type === 5) {
    if (A.value.length === 3) {
      ...
      return te(parseInt(r + r, 16), parseInt(n + n, 16), parseInt(s + s, 16), 1);
    }
    if (A.value.length === 4) {
      r = A.value.substring(0, 1), n = A.value.substring(1, 2), s = A.value.substring(2, 3);
      var o = A.value.substring(3, 4);
      return te(parseInt(r + r, 16), parseInt(n + n, 16), parseInt(s + s, 16), parseInt(o + o, 16) / 255);
    }
    if (A.value.length === 6)
      return r = A.value.substring(0, 2), n = A.value.substring(2, 4), s = A.value.substring(4, 6), te(parseInt(r, 16), parseInt(n, 16), parseInt(s, 16), 1);
    if (A.value.length === 8)
      return r = A.value.substring(0, 2), n = A.value.substring(2, 4), s = A.value.substring(4, 6), o = A.value.substring(6, 8), te(parseInt(r, 16), parseInt(n, 16), parseInt(s, 16), parseInt(o, 16) / 255);
  }
  if (A.type === 20) {
    var i = ne[A.value.toUpperCase()];
    if (i !== void 0)
      return i;
  }
  return ne.TRANSPARENT;
}, le = function(e) {
  return (255 & e) == 0;
}, oA = function(e) {
  ...
  var t = A.filter(pe);
  if (t.length === 3) {
    var r = t.map(os), n = r[0], s = r[1], o = r[2];
    return te(n, s, o, 1);
  }
  if (t.length === 4) {
    var i = t.map(os), c = (n = i[0], s = i[1], o = i[2], i[3]);
    return te(n, s, o, c);
  }
  return 0;
};
...
var as = function(e, A) {
  var t = A.filter(pe), r = t[0], n = t[1], s = t[2], o = t[3], i = (r.type === 17 ? kA(r.number) : ot(e, r)) / (2 * Math.PI), c = Z(n) ? n.number / 100 : 0, B = Z(s) ? s.number / 100 : 0, a = o !== void 0 && Z(o) ? N(o, 1) : 1;
  if (c === 0)
    return te(255 * B, 255 * B, 255 * B, 1);
  var l = B <= 0.5 ? B * (c + 1) : B + c - B * c, d = 2 * B - l, g = mr(d, l, i + 1 / 3), u = mr(d, l, i), w = mr(d, l, i - 1 / 3);
  return te(255 * g, 255 * u, 255 * w, a);
}, yr = function(e, A, t) {
  return Math.min(Math.max(e, A), t);
}, Ia = { hsl: as, hsla: as, rgb: is, rgba: is, oklch: function(e, A) {
  var t = A.filter(pe), r = t[0], n = t[1], s = t[2], o = t[3], i = Z(r) ? r.number / 100 : 0, c = Z(n) ? n.number / 100 : 0, B = s.type === 17 ? kA(s.number) : ot(e, s), a = o !== void 0 && Z(o) ? N(o, 1) : 1, l = B / (180 * Math.PI), d = 255 * i, g = 128 * c, u = g * Math.cos(l), w = g * Math.sin(l), h = d - 0.57735 * u - 1.1547 * w, p = d + 1.73205 * w;
  return te(yr(d + u, 0, 255), yr(h, 0, 255), yr(p, 0, 255), a);
} }, je = function(e, A) {
  return Be(e, io.create(A).parseComponentValue());
}, ne = { ALICEBLUE: 4042850303, ANTIQUEWHITE: 4209760255, AQUA: 16777215, AQUAMARINE: 2147472639, AZURE: 4043309055, BEIGE: 4126530815, BISQUE: 4293182719, BLACK: 255, BLANCHEDALMOND: 4293643775, BLUE: 65535, BLUEVIOLET: 2318131967, BROWN: 2771004159, BURLYWOOD: 3736635391, CADETBLUE: 1604231423, CHARTREUSE: 2147418367, CHOCOLATE: 3530104575, CORAL: 4286533887, CORNFLOWERBLUE: 1687547391, CORNSILK: 4294499583, CRIMSON: 3692313855, CYAN: 16777215, DARKBLUE: 35839, DARKCYAN: 9145343, DARKGOLDENROD: 3095837695, DARKGRAY: 2846468607, DARKGREEN: 6553855, DARKGREY: 2846468607, DARKKHAKI: 3182914559, DARKMAGENTA: 2332068863, DARKOLIVEGREEN: 1433087999, DARKORANGE: 4287365375, DARKORCHID: 2570243327, DARKRED: 2332033279, DARKSALMON: 3918953215, DARKSEAGREEN: 2411499519, DARKSLATEBLUE: 1211993087, DARKSLATEGRAY: 793726975, DARKSLATEGREY: 793726975, DARKTURQUOISE: 13554175, DARKVIOLET: 2483082239, DEEPPINK: 4279538687, DEEPSKYBLUE: 12582911, DIMGRAY: 1768516095, DIMGREY: 1768516095, DODGERBLUE: 512819199, FIREBRICK: 2988581631, FLORALWHITE: 4294635775, FORESTGREEN: 579543807, FUCHSIA: 4278255615, GAINSBORO: 3705462015, GHOSTWHITE: 4177068031, GOLD: 4292280575, GOLDENROD: 3668254975, GRAY: 2155905279, GREEN: 8388863, GREENYELLOW: 2919182335, GREY: 2155905279, HONEYDEW: 4043305215, HOTPINK: 4285117695, INDIANRED: 3445382399, INDIGO: 1258324735, IVORY: 4294963455, KHAKI: 4041641215, LAVENDER: 3873897215, LAVENDERBLUSH: 4293981695, LAWNGREEN: 2096890111, LEMONCHIFFON: 4294626815, LIGHTBLUE: 2916673279, LIGHTCORAL: 4034953471, LIGHTCYAN: 3774873599, LIGHTGOLDENRODYELLOW: 4210742015, LIGHTGRAY: 3553874943, LIGHTGREEN: 2431553791, LIGHTGREY: 3553874943, LIGHTPINK: 4290167295, LIGHTSALMON: 4288707327, LIGHTSEAGREEN: 548580095, LIGHTSKYBLUE: 2278488831, LIGHTSLATEGRAY: 2005441023, LIGHTSLATEGREY: 2005441023, LIGHTSTEELBLUE: 2965692159, LIGHTYELLOW: 4294959359, LIME: 16711935, LIMEGREEN: 852308735, LINEN: 4210091775, MAGENTA: 4278255615, MAROON: 2147483903, MEDIUMAQUAMARINE: 1724754687, MEDIUMBLUE: 52735, MEDIUMORCHID: 3126187007, MEDIUMPURPLE: 2473647103, MEDIUMSEAGREEN: 1018393087, MEDIUMSLATEBLUE: 2070474495, MEDIUMSPRINGGREEN: 16423679, MEDIUMTURQUOISE: 1221709055, MEDIUMVIOLETRED: 3340076543, MIDNIGHTBLUE: 421097727, MINTCREAM: 4127193855, MISTYROSE: 4293190143, MOCCASIN: 4293178879, NAVAJOWHITE: 4292783615, NAVY: 33023, OLDLACE: 4260751103, OLIVE: 2155872511, OLIVEDRAB: 1804477439, ORANGE: 4289003775, ORANGERED: 4282712319, ORCHID: 3664828159, PALEGOLDENROD: 4008225535, PALEGREEN: 2566625535, PALETURQUOISE: 2951671551, PALEVIOLETRED: 3681588223, PAPAYAWHIP: 4293907967, PEACHPUFF: 4292524543, PERU: 3448061951, PINK: 4290825215, PLUM: 3718307327, POWDERBLUE: 2967529215, PURPLE: 2147516671, REBECCAPURPLE: 1714657791, RED: 4278190335, ROSYBROWN: 3163525119, ROYALBLUE: 1097458175, SADDLEBROWN: 2336560127, SALMON: 4202722047, SANDYBROWN: 4104413439, SEAGREEN: 780883967, SEASHELL: 4294307583, SIENNA: 2689740287, SILVER: 3233857791, SKYBLUE: 2278484991, SLATEBLUE: 1784335871, SLATEGRAY: 1887473919, SLATEGREY: 1887473919, SNOW: 4294638335, SPRINGGREEN: 16744447, STEELBLUE: 1182971135, TAN: 3535047935, TEAL: 8421631, THISTLE: 3636451583, TOMATO: 4284696575, TRANSPARENT: 0, TURQUOISE: 1088475391, VIOLET: 4001558271, WHEAT: 4125012991, WHITE: 4294967295, WHITESMOKE: 4126537215, YELLOW: 4294902015, YELLOWGREEN: 2597139199 }, xa = { name: "background-clip", initialValue: "border-box", prefix: !1, type: 1, parse: function(e, A) {
...
} }, Ka = { name: "background-color", initialValue: "transparent", prefix: !1, type: 3, format: "color" }, Nt = function(e, A) {
  var t = Be(e, A[0]), r = A[1];
  return r && Z(r) ? { color: t, stop: r } : { color: t, stop: null };
}, cs = function(e, A) {
  var t = e[0], r = e[e.length - 1];
  t.stop === null && (t.stop = dA), r.stop === null && (r.stop = ce);
  ...
  return WA(A).forEach(function(n, s) {
    if (s === 0) {
      ...
      if (o.type === 20 && ["top", "left", "right", "bottom"].indexOf(o.value) !== -1)
        return void (t = uo(n));
      if (lo(o))
        return void (t = (ot(e, o) + kA(270)) % kA(360));
    }
    var i = Nt(e, n);
    r.push(i);
  }), { angle: t, stops: r, type: 1 };
}, go = "closest-side", wo = "farthest-side", ho = "closest-corner", Qo = "farthest-corner", po = "circle", Co = "ellipse", fo = "cover", Uo = "contain", Ft = function(e, A) {
  var t = 0, r = 3, n = [], s = [];
...
}, Le, Fo = { "linear-gradient": function(e, A) {
  var t = kA(180), r = [];
  return WA(A).forEach(function(n, s) {
    if (s === 0) {
      var o = n[0];
      if (o.type === 20 && o.value === "to")
        return void (t = uo(n));
      if (lo(o))
        return void (t = ot(e, o));
    }
    var i = Nt(e, n);
    r.push(i);
  }), { angle: t, stops: r, type: 1 };
}, "-moz-linear-gradient": Ut, "-ms-linear-gradient": Ut, "-o-linear-gradient": Ut, "-webkit-linear-gradient": Ut, "radial-gradient": function(e, A) {
  var t = 0, r = 3, n = [], s = [];
  return WA(A).forEach(function(o, i) {
    var c = !0;
    if (i === 0) {
...
}, "-moz-radial-gradient": Ft, "-ms-radial-gradient": Ft, "-o-radial-gradient": Ft, "-webkit-radial-gradient": Ft, "-webkit-gradient": function(e, A) {
  var t = kA(180), r = [], n = 1;
  return WA(A).forEach(function(s, o) {
    ...
    if (i.type === 18) {
      if (i.name === "from") {
        ...
        c = Be(e, i.values[0]), r.push({ stop: ce, color: c });
      else if (i.name === "color-stop") {
        var B = i.values.filter(pe);
        if (B.length === 2) {
          c = Be(e, B[1]);
          var a = B[0];
          ke(a) && r.push({ stop: { type: 16, number: 100 * a.number, flags: a.flags }, color: c });
        }
      }
    }
  ...
  return t.type === 20 && t.value === "none" ? [] : A.filter(function(r) {
    return pe(r) && function(n) {
      return !(n.type === 20 && n.value === "none" || n.type === 18 && !Fo[n.name]);
    }(r);
  }).map(function(r) {
    return pn(e, r);
  });
...
var Xt, Ra = { name: "background-size", initialValue: "0", prefix: !1, type: 1, parse: function(e, A) {
  return WA(A).map(function(t) {
    return t.filter(Ga);
  });
} }, Ga = function(e) {
  ...
  return { name: "border-radius-" + e, initialValue: "0 0", prefix: !1, type: 1, parse: function(A, t) {
    return ao(t.filter(Z));
  } };
}, Xa = ir("top-left"), Ja = ir("top-right"), Ya = ir("bottom-right"), Wa = ir("bottom-left"), ar = function(e) {
...
}, ja = ar("top"), Za = ar("right"), qa = ar("bottom"), za = ar("left"), cr = function(e) {
...
var Ze, cc = { name: "line-break", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  return A === "strict" ? Xt.STRICT : Xt.NORMAL;
} }, Bc = { name: "line-height", initialValue: "normal", prefix: !1, type: 4 }, ls = function(e, A) {
  ...
  return A.length === 1 && Xr(A[0], "none") ? [] : WA(A).map(function(t) {
    for (var r = { color: ne.TRANSPARENT, offsetX: dA, offsetY: dA, blur: dA }, n = 0, s = 0; s < t.length; s++) {
      var o = t[s];
...
} }, ds = { type: 16, number: 50, flags: 4 }, vc = [ds, ds], Ic = { name: "transform-origin", initialValue: "50% 50%", prefix: !0, type: 1, parse: function(e, A) {
  var t = A.filter(Z);
...
for (var Kc = { name: "word-break", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  ...
  return ke(A) ? A.number : P(A) && A.value === "bold" ? 700 : 400;
  ...
  if (t.type === 20 && t.value === "none")
    return null;
  for (var r = [], n = A.filter(ss), s = 0; s < n.length; s++) {
    var o = n[s], i = n[s + 1];
    if (o.type === 20) {
      var c = i && ke(i) ? i.number : 1;
  ...
  if (A.length === 0)
    return [];
  for (var t = [], r = A.filter(ss), n = 0; n < r.length; n++) {
    var s = r[n], o = r[n + 1];
    if (P(s) && s.value !== "none") {
      var i = o && ke(o) ? o.number : 0;
...
}, Yc = { name: "box-shadow", initialValue: "none", type: 1, prefix: !1, parse: function(e, A) {
  return A.length === 1 && Xr(A[0], "none") ? [] : WA(A).map(function(t) {
...
} }, Wc = { name: "paint-order", initialValue: "normal", prefix: !1, type: 1, parse: function(e, A) {
  var t = [];
...
} }, jc = { name: "-webkit-text-stroke-color", initialValue: "currentcolor", prefix: !1, type: 3, format: "color" }, Zc = { name: "-webkit-text-stroke-width", initialValue: "0", type: 0, prefix: !1, parse: function(e, A) {
  return At(A) ? A.number : 0;
} }, qc = { name: "objectFit", initialValue: "fill", prefix: !1, type: 1, parse: function(e, A) {
  return A.filter(P).reduce(function(t, r) {
    return t | zc(r.value);
  }, 0);
} }, zc = function(e) {
  ...
  var r = new oo(), n = t != null ? t.toString() : A.initialValue;
  r.write(n);
  var s = new io(r.read());
  switch (A.type) {
    case 2:
    ...
    case 3:
      switch (A.format) {
        case "angle":
          return ot(e, s.parseComponentValue());
        case "color":
        ...
        case "length-percentage":
          ...
          return Z(c) ? c : dA;
        case "time":
          return us(e, s.parseComponentValue());
      }
  }
}, Yr = function(e, A) {
  var t = function(r) {
  ...
  this.context = e, this.textNodes = [], this.elements = [], this.flags = 0, Yr(A, 3), this.styles = new $c(e, window.getComputedStyle(A, null)), Zr(A) && (this.styles.animationDuration.some(function(t) {
    return t > 0;
  }) && (A.style.animationDuration = "0s"), this.styles.transform !== null && (A.style.transform = "none")), this.bounds = sr(this.context, A), Yr(A, 4) && (this.flags |= 16);
}, eB = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Je = typeof Uint8Array > "u" ? [] : new Uint8Array(256), mt = 0; mt < 64; mt++)
  Je[eB.charCodeAt(mt)] = mt;
for (var hs = function(e, A, t) {
  return e.slice ? e.slice(A, t) : new Uint16Array(Array.prototype.slice.call(e, A, t));
}, tB = function() {
  function e(A, t, r, n, s, o) {
    this.initialValue = A, this.errorValue = t, this.highStart = r, this.highValueIndex = n, this.index = s, this.data = o;
...
}(), rB = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", nB = typeof Uint8Array > "u" ? [] : new Uint8Array(256), yt = 0; yt < 64; yt++)
  nB[rB.charCodeAt(yt)] = yt;
var qe, Qs = 8, Er = 9, ps = 11, Cs = 12, sB = function() {
  for (var e = [], A = 0; A < arguments.length; A++)
    e[A] = arguments[A];
  if (String.fromCodePoint)
    return String.fromCodePoint.apply(String, e);
  ...
  var t, r, n, s = function(a) {
    ...
    for (var l = a.length, d = [], g = 0; g < l; g += 2)
      d.push(a[g + 1] << 8 | a[g]);
    return d;
  }(s) : new Uint16Array(s), c = hs(i, 12, o[4] / 2), B = o[5] === 2 ? hs(i, (24 + o[4]) / 2) : (t = o, r = Math.ceil((24 + o[4]) / 4), t.slice ? t.slice(r, n) : new Uint32Array(Array.prototype.slice.call(t, r, n)));
  return new tB(o[0], o[1], o[2], o[3], c, B);
  ...
  if (s === 2 || s === 3 || s === 4 || o === 2 || o === 3 || o === 4)
    return "÷";
  if (s === Qs && [Qs, Er, ps, Cs].indexOf(o) !== -1 || !(s !== ps && s !== Er || o !== Er && o !== 10) || (s === Cs || s === 10) && o === 10 || o === 13 || o === 5 || o === 7 || s === 1)
    return LA;
  if (s === 13 && o === 14) {
    for (; n === 5; )
      n = A[--r];
  ...
  var A = function(o) {
    ...
    return i;
  }(e), t = A.length, r = 0, n = 0, s = A.map(iB);
  return { next: function() {
    if (r >= t)
      return { done: !0, value: null };
    for (var o = LA; r < t && (o = aB(0, s, ++r)) === LA; )
      ;
    if (o !== LA || r === t) {
      var i = sB.apply(null, A.slice(n, r));
  ...
  var e = typeof Array.from == "function" && typeof window.fetch == "function" ? function(A) {
    ...
    s.src = o;
    var i = Wr(r, r, 0, 0, s);
    return n.fillStyle = "red", n.fillRect(0, 0, r, r), Us(i).then(function(c) {
      n.drawImage(c, 0, 0);
      var B = n.getImageData(0, 0, r, r).data;
      n.fillStyle = "red", n.fillRect(0, 0, r, r);
      var a = A.createElement("div");
      return a.style.backgroundImage = "url(" + o + ")", a.style.height = r + "px", fs(B) ? Us(Wr(r, r, 0, 0, a)) : Promise.reject(!1);
    }).then(function(c) {
      return n.drawImage(c, 0, 0), fs(n.getImageData(0, 0, r, r).data);
    }).catch(function() {
      return !1;
    });
  ...
  return function(t) {
    for (var r, n = cB(t), s = []; !(r = n.next()).done; )
...
}, dB = [32, 160, 4961, 65792, 65793, 4153, 4241], uB = function(e, A) {
  for (var t, r = function(o, i) {
    var c = Pt(o), B = sa(c, i), a = B[0], l = B[1], d = B[2], g = c.length, u = 0, w = 0;
    return { next: function() {
      if (w >= g)
        return { done: !0, value: null };
    ...
    if (t.value) {
      ...
      i.forEach(function(B) {
        dB.indexOf(B) === -1 ? c += $(B) : (c.length && n.push(c), n.push($(B)), c = "");
      }), c.length && n.push(c);
    }
  }; !(t = r.next()).done; )
    s();
  ...
  this.text = wB(A.data, t.textTransform), this.textBounds = function(r, n, s, o) {
    var i = lB(n, s), c = [], B = 0;
    return i.forEach(function(a) {
      if (s.textDecorationLine.length || a.trim().length > 0)
        if (lA.SUPPORT_RANGE_BOUNDS) {
          var l = Fs(o, B, a.length).getClientRects();
          if (l.length > 1) {
            var d = Cn(a), g = 0;
            d.forEach(function(w) {
              c.push(new ze(w, se.fromDOMRectList(r, Fs(o, g + B, w.length).getClientRects()))), g += w.length;
            });
          } else
            c.push(new ze(a, se.fromDOMRectList(r, l)));
        } else {
          var u = o.splitText(a.length);
          c.push(new ze(a, BB(r, o))), o = u;
        }
      else
  ...
  return RA(A, e), A;
}(qA), pB = [{ type: 15, flags: 0, unit: "px", number: 3 }], CB = [{ type: 16, flags: 0, number: 50 }], Jt = "checkbox", Yt = "radio", fB = "password", ms = 707406591, fn = function(e) {
  function A(t, r) {
    var n, s, o, i = e.call(this, t, r) || this;
    switch (i.type = r.type.toLowerCase(), i.checked = r.checked, i.value = (s = (n = r).type === fB ? new Array(n.value.length + 1).join("•") : n.value).length === 0 ? n.placeholder || "" : s, i.type !== Jt && i.type !== Yt || (i.styles.backgroundColor = 3739148031, i.styles.borderTopColor = i.styles.borderRightColor = i.styles.borderBottomColor = i.styles.borderLeftColor = 2779096575, i.styles.borderTopWidth = i.styles.borderRightWidth = i.styles.borderBottomWidth = i.styles.borderLeftWidth = 1, i.styles.borderTopStyle = i.styles.borderRightStyle = i.styles.borderBottomStyle = i.styles.borderLeftStyle = 1, i.styles.backgroundClip = [0], i.styles.backgroundOrigin = [0], i.bounds = (o = i.bounds).width > o.height ? new se(o.left + (o.width - o.height) / 2, o.top, o.height, o.height) : o.width < o.height ? new se(o.left, o.top + (o.height - o.width) / 2, o.width, o.width) : o), i.type) {
      case Jt:
  ...
  function A(t, r) {
    ...
    try {
      if (r.contentWindow && r.contentWindow.document && r.contentWindow.document.documentElement) {
        n.tree = xo(t, r.contentWindow.document.documentElement);
        var s = r.contentWindow.document.documentElement ? je(t, getComputedStyle(r.contentWindow.document.documentElement).backgroundColor) : ne.TRANSPARENT, o = r.contentWindow.document.body ? je(t, getComputedStyle(r.contentWindow.document.body).backgroundColor) : ne.TRANSPARENT;
  ...
  return RA(A, e), A;
}(qA), UB = ["OL", "UL", "MENU"], Dt = function(e, A, t, r) {
  for (var n = A.firstChild, s = void 0; n; n = s)
    if (s = n.nextSibling, Ko(n) && n.data.trim().length > 0)
      t.textNodes.push(new gB(e, n, t.styles));
    else if (Ie(n))
      if (To(n) && n.assignedNodes)
        n.assignedNodes().forEach(function(i) {
          return Dt(e, i, t, r);
        });
      else {
        var o = Io(e, n);
        o.styles.isVisible() && (FB(n, o, r) ? o.flags |= 4 : mB(o.styles) && (o.flags |= 2), UB.indexOf(n.tagName) !== -1 && (o.flags |= 8), t.elements.push(o), n.slot, n.shadowRoot ? Dt(e, n.shadowRoot, o, r) : Wt(n) || Lo(n) || jt(n) || Dt(e, n, o, r));
      }
}, Io = function(e, A) {
  return qr(A) ? new mo(e, A) : So(A) ? new yo(e, A) : Lo(A) ? new Eo(e, A) : yB(A) ? new bo(e, A) : EB(A) ? new jr(e, A) : bB(A) ? new fn(e, A) : jt(A) ? new Ho(e, A) : Wt(A) ? new ko(e, A) : Do(A) ? new vo(e, A) : new qA(e, A);
}, xo = function(e, A) {
  var t = Io(e, A);
  ...
  return Ie(e) && e.style !== void 0 && !Tt(e);
}, Tt = function(e) {
  ...
  var s = t - A + 1;
  return (e < 0 ? "-" : "") + (Oo(Math.abs(e), s, r, function(o) {
    return $(Math.floor(o % s) + A);
  }) + n);
}, we = function(e, A, t) {
  t === void 0 && (t = ". ");
  var r = A.length;
  return Oo(Math.abs(e), r, !1, function(n) {
  ...
  return (e < 0 ? r : "") + i;
}, vs = "十百千萬", Is = "拾佰仟萬", xs = "マイナス", br = "마이너스", et = function(e, A, t) {
  var r = t ? ". " : "", n = t ? "、" : "", s = t ? ", " : "", o = t ? " " : "";
  switch (A) {
    case 0:
      return "•" + o;
    ...
    case 6:
      return me(e, 1, 3999, Hs, 3, r).toLowerCase();
    case 7:
      return me(e, 1, 3999, Hs, 3, r);
    case 8:
    ...
    case 12:
    case 49:
      return me(e, 1, 9999, ks, 3, r);
    case 35:
      return me(e, 1, 9999, ks, 3, r).toLowerCase();
    case 13:
    ...
    case 17:
    case 48:
      return ee(e, "零一二三四五六七八九", vs, "負", n, 14);
    case 47:
      return ee(e, "零壹貳參肆伍陸柒捌玖", Is, "負", n, 15);
    case 42:
      return ee(e, "零一二三四五六七八九", vs, "负", n, 14);
    case 41:
      return ee(e, "零壹贰叁肆伍陆柒捌玖", Is, "负", n, 15);
    case 26:
      return ee(e, "〇一二三四五六七八九", "十百千万", xs, n, 0);
    case 25:
      return ee(e, "零壱弐参四伍六七八九", "拾百千万", xs, n, 7);
    case 31:
      return ee(e, "영일이삼사오육칠팔구", "십백천만", br, s, 7);
    case 33:
      return ee(e, "零一二三四五六七八九", "十百千萬", br, s, 0);
    case 32:
      return ee(e, "零壹貳參四五六七八九", "拾百千", br, s, 7);
    case 18:
      return z(e, 2406, 2415, !0, r);
    case 20:
      return me(e, 1, 19999, vB, 3, r);
    case 21:
      return z(e, 2790, 2799, !0, r);
    case 22:
      return z(e, 2662, 2671, !0, r);
    case 22:
      return me(e, 1, 10999, kB, 3, r);
    case 23:
...
}, Mo = "data-html2canvas-ignore", Ks = function() {
  function e(A, t, r) {
    if (this.context = A, this.options = r, this.scrolledElements = [], this.referenceElement = t, this.counters = new HB(), this.quoteDepth = 0, !t.ownerDocument)
  ...
  return e.prototype.toIFrame = function(A, t) {
    ...
    var s = A.defaultView.pageXOffset, o = A.defaultView.pageYOffset, i = n.contentWindow, c = i.document, B = LB(n).then(function() {
      return fA(r, void 0, void 0, function() {
        var a, l;
        return QA(this, function(d) {
          switch (d.label) {
            case 0:
              return this.scrolledElements.forEach(OB), i && (i.scrollTo(t.left, t.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || i.scrollY === t.top && i.scrollX === t.left || (this.context.logger.warn("Unable to restore scroll position for cloned document"), this.context.windowBounds = this.context.windowBounds.add(i.scrollX - t.left, i.scrollY - t.top, 0, 0))), a = this.options.onclone, (l = this.clonedReferenceElement) === void 0 ? [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")] : c.fonts && c.fonts.ready ? [4, c.fonts.ready] : [3, 2];
            case 1:
              d.sent(), d.label = 2;
            case 2:
              return /(AppleWebKit)/g.test(navigator.userAgent) ? [4, KB(c)] : [3, 4];
            case 3:
              d.sent(), d.label = 4;
            case 4:
    ...
    return c.open(), c.write(DB(document.doctype) + "<html></html>"), TB(this.referenceElement.ownerDocument, s, o), c.replaceChild(c.adoptNode(this.documentElement), c.documentElement), c.close(), B;
    ...
    var t = A.cloneNode(!1);
    return qr(t) && (qr(A) && A.currentSrc && A.currentSrc !== A.src && (t.src = A.currentSrc, t.srcset = ""), t.loading === "lazy" && (t.loading = "eager")), bs(t) ? this.createCustomElementClone(t) : t;
    ...
    Ie(t) && (t.tagName === "SCRIPT" || t.hasAttribute(Mo) || typeof this.options.ignoreElements == "function" && this.options.ignoreElements(t)) || this.options.copyStyles && Ie(t) && Es(t) || A.appendChild(this.cloneNode(t, r));
  }, e.prototype.cloneChildNodes = function(A, t, r) {
    for (var n = this, s = A.shadowRoot ? A.shadowRoot.firstChild : A.firstChild; s; s = s.nextSibling)
      if (Ie(s) && To(s) && typeof s.assignedNodes == "function") {
    ...
    if (r && Ie(A) && (Zr(A) || Tt(A))) {
      ...
      this.referenceElement === A && Zr(n) && (this.clonedReferenceElement = n), Un(n) && MB(n);
      var c = this.counters.parse(new ws(this.context, s)), B = this.resolvePseudoContent(A, n, o, qe.BEFORE);
      bs(A) && (t = !0), ys(A) || this.cloneChildNodes(A, n, t), B && n.insertBefore(B, n.firstChild);
      var a = this.resolvePseudoContent(A, n, i, qe.AFTER);
      return a && n.appendChild(a), this.counters.pop(c), (s && (this.options.copyStyles || Tt(A)) && !Do(A) || t) && Hr(s, n), A.scrollTop === 0 && A.scrollLeft === 0 || this.scrolledElements.push([n, A.scrollLeft, A.scrollTop]), (Wt(A) || jt(A)) && (Wt(n) || jt(n)) && (n.value = A.value), n;
    }
    return A.cloneNode(!1);
    ...
    if (r) {
      ...
      if (i && o && o !== "none" && o !== "-moz-alt-content" && r.display !== "none") {
        this.counters.parse(new ws(this.context, r));
        var c = new AB(this.context, r), B = i.createElement("html2canvaspseudoelement");
        Hr(r, B), c.content.forEach(function(l) {
          if (l.type === 0)
            ...
            if (l.name === "attr") {
              ...
              var u = l.values.filter(pe), w = u[0], h = u[1];
              if (w && P(w)) {
              ...
              var E = l.values.filter(pe), U = (w = E[0], E[1]);
              if (h = E[2], w && P(w)) {
                var C = s.counters.getCounterValues(w.value), H = h && P(h) ? Jr.parse(s.context, h.value) : 3, v = U && U.type === 0 ? U.value : "", b = C.map(function(_) {
                  return et(_, H, !1);
                }).join(v);
            ...
            switch (l.value) {
              case "open-quote":
                B.appendChild(i.createTextNode(gs(c.quotes, s.quoteDepth++, !0)));
                break;
              case "close-quote":
                B.appendChild(i.createTextNode(gs(c.quotes, --s.quoteDepth, !1)));
                break;
              default:
                B.appendChild(i.createTextNode(l.value));
            }
        ...
        return Tt(t) ? t.className.baseValue += a : t.className += a, B;
      }
    }
...
var G, IB = function(e, A) {
  var t = e.createElement("iframe");
  return t.className = "html2canvas-container", t.style.visibility = "hidden", t.style.position = "fixed", t.style.left = "-10000px", t.style.top = "0px", t.style.border = "0", t.width = A.width.toString(), t.height = A.height.toString(), t.scrolling = "no", t.setAttribute(Mo, "true"), e.body.appendChild(t), t;
}, xB = function(e) {
  return new Promise(function(A) {
    e.complete ? A() : e.src ? (e.onload = A, e.onerror = A) : A();
  });
}, KB = function(e) {
  return Promise.all([].slice.call(e.images, 0).map(xB));
}, LB = function(e) {
  return new Promise(function(A, t) {
...
}, SB = ["all", "d", "content"], Hr = function(e, A) {
  for (var t = e.length - 1; t >= 0; t--) {
    var r = e.item(t);
    SB.indexOf(r) === -1 && A.style.setProperty(r, e.getPropertyValue(r));
  }
  return A;
}, DB = function(e) {
  var A = "";
...
}, zr = "___html2canvas___pseudoelement_before", $r = "___html2canvas___pseudoelement_after", Ls = `{
    content: "" !important;
  ...
  return e.prototype.addImage = function(A) {
    ...
    return this.has(A) || (vr(A) || NB(A)) && (this._cache[A] = this.loadImage(A)).catch(function() {
    }), t;
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(i) {
        switch (i.label) {
          case 0:
            return t = Ro.isSameOrigin(A), r = !kr(A) && this._options.useCORS === !0 && lA.SUPPORT_CORS_IMAGES && !t, n = !kr(A) && !t && !vr(A) && typeof this._options.proxy == "string" && lA.SUPPORT_CORS_XHR && !r, t || this._options.allowTaint !== !1 || kr(A) || vr(A) || n || r ? (s = A, n ? [4, this.proxy(s)] : [3, 2]) : [2];
          case 1:
            s = i.sent(), i.label = 2;
          case 2:
            return this.context.logger.debug("Added image " + A.substring(0, 256)), [4, new Promise(function(c, B) {
              ...
              a.onload = function() {
                return c(a);
              }, a.onerror = B, (XB(s) || r) && (a.crossOrigin = "anonymous"), a.src = s, a.complete === !0 && setTimeout(function() {
                return c(a);
...
}(), VB = /^data:image\/svg\+xml/i, PB = /^data:image\/.*;base64,/i, _B = /^data:image\/.*/i, NB = function(e) {
  return lA.SUPPORT_SVG_DRAWING || !JB(e);
}, kr = function(e) {
  return _B.test(e);
}, XB = function(e) {
  return PB.test(e);
  ...
  return e.prototype.subdivide = function(A, t) {
    var r = ye(this.start, this.startControl, A), n = ye(this.startControl, this.endControl, A), s = ye(this.endControl, this.end, A), o = ye(r, n, A), i = ye(n, s, A), c = ye(o, i, A);
  ...
  var p = t.width - i, f = t.height - l, E = t.width - a, U = t.height - u, C = A.borderTopWidth, H = A.borderRightWidth, v = A.borderBottomWidth, b = A.borderLeftWidth, _ = N(A.paddingTop, e.bounds.width), eA = N(A.paddingRight, e.bounds.width), gA = N(A.paddingBottom, e.bounds.width), Y = N(A.paddingLeft, e.bounds.width);
  this.topLeftBorderDoubleOuterBox = n > 0 || s > 0 ? X(t.left + b / 3, t.top + C / 3, n - b / 3, s - C / 3, G.TOP_LEFT) : new m(t.left + b / 3, t.top + C / 3), this.topRightBorderDoubleOuterBox = n > 0 || s > 0 ? X(t.left + p, t.top + C / 3, i - H / 3, c - C / 3, G.TOP_RIGHT) : new m(t.left + t.width - H / 3, t.top + C / 3), this.bottomRightBorderDoubleOuterBox = a > 0 || l > 0 ? X(t.left + E, t.top + f, a - H / 3, l - v / 3, G.BOTTOM_RIGHT) : new m(t.left + t.width - H / 3, t.top + t.height - v / 3), this.bottomLeftBorderDoubleOuterBox = g > 0 || u > 0 ? X(t.left + b / 3, t.top + U, g - b / 3, u - v / 3, G.BOTTOM_LEFT) : new m(t.left + b / 3, t.top + t.height - v / 3), this.topLeftBorderDoubleInnerBox = n > 0 || s > 0 ? X(t.left + 2 * b / 3, t.top + 2 * C / 3, n - 2 * b / 3, s - 2 * C / 3, G.TOP_LEFT) : new m(t.left + 2 * b / 3, t.top + 2 * C / 3), this.topRightBorderDoubleInnerBox = n > 0 || s > 0 ? X(t.left + p, t.top + 2 * C / 3, i - 2 * H / 3, c - 2 * C / 3, G.TOP_RIGHT) : new m(t.left + t.width - 2 * H / 3, t.top + 2 * C / 3), this.bottomRightBorderDoubleInnerBox = a > 0 || l > 0 ? X(t.left + E, t.top + f, a - 2 * H / 3, l - 2 * v / 3, G.BOTTOM_RIGHT) : new m(t.left + t.width - 2 * H / 3, t.top + t.height - 2 * v / 3), this.bottomLeftBorderDoubleInnerBox = g > 0 || u > 0 ? X(t.left + 2 * b / 3, t.top + U, g - 2 * b / 3, u - 2 * v / 3, G.BOTTOM_LEFT) : new m(t.left + 2 * b / 3, t.top + t.height - 2 * v / 3), this.topLeftBorderStroke = n > 0 || s > 0 ? X(t.left + b / 2, t.top + C / 2, n - b / 2, s - C / 2, G.TOP_LEFT) : new m(t.left + b / 2, t.top + C / 2), this.topRightBorderStroke = n > 0 || s > 0 ? X(t.left + p, t.top + C / 2, i - H / 2, c - C / 2, G.TOP_RIGHT) : new m(t.left + t.width - H / 2, t.top + C / 2), this.bottomRightBorderStroke = a > 0 || l > 0 ? X(t.left + E, t.top + f, a - H / 2, l - v / 2, G.BOTTOM_RIGHT) : new m(t.left + t.width - H / 2, t.top + t.height - v / 2), this.bottomLeftBorderStroke = g > 0 || u > 0 ? X(t.left + b / 2, t.top + U, g - b / 2, u - v / 2, G.BOTTOM_LEFT) : new m(t.left + b / 2, t.top + t.height - v / 2), this.topLeftBorderBox = n > 0 || s > 0 ? X(t.left, t.top, n, s, G.TOP_LEFT) : new m(t.left, t.top), this.topRightBorderBox = i > 0 || c > 0 ? X(t.left + p, t.top, i, c, G.TOP_RIGHT) : new m(t.left + t.width, t.top), this.bottomRightBorderBox = a > 0 || l > 0 ? X(t.left + E, t.top + f, a, l, G.BOTTOM_RIGHT) : new m(t.left + t.width, t.top + t.height), this.bottomLeftBorderBox = g > 0 || u > 0 ? X(t.left, t.top + U, g, u, G.BOTTOM_LEFT) : new m(t.left, t.top + t.height), this.topLeftPaddingBox = n > 0 || s > 0 ? X(t.left + b, t.top + C, Math.max(0, n - b), Math.max(0, s - C), G.TOP_LEFT) : new m(t.left + b, t.top + C), this.topRightPaddingBox = i > 0 || c > 0 ? X(t.left + Math.min(p, t.width - H), t.top + C, p > t.width + H ? 0 : Math.max(0, i - H), Math.max(0, c - C), G.TOP_RIGHT) : new m(t.left + t.width - H, t.top + C), this.bottomRightPaddingBox = a > 0 || l > 0 ? X(t.left + Math.min(E, t.width - b), t.top + Math.min(f, t.height - v), Math.max(0, a - H), Math.max(0, l - v), G.BOTTOM_RIGHT) : new m(t.left + t.width - H, t.top + t.height - v), this.bottomLeftPaddingBox = g > 0 || u > 0 ? X(t.left + b, t.top + Math.min(U, t.height - v), Math.max(0, g - b), Math.max(0, u - v), G.BOTTOM_LEFT) : new m(t.left + b, t.top + t.height - v), this.topLeftContentBox = n > 0 || s > 0 ? X(t.left + b + Y, t.top + C + _, Math.max(0, n - (b + Y)), Math.max(0, s - (C + _)), G.TOP_LEFT) : new m(t.left + b + Y, t.top + C + _), this.topRightContentBox = i > 0 || c > 0 ? X(t.left + Math.min(p, t.width + b + Y), t.top + C + _, p > t.width + b + Y ? 0 : i - b + Y, c - (C + _), G.TOP_RIGHT) : new m(t.left + t.width - (H + eA), t.top + C + _), this.bottomRightContentBox = a > 0 || l > 0 ? X(t.left + Math.min(E, t.width - (b + Y)), t.top + Math.min(f, t.height + C + _), Math.max(0, a - (H + eA)), l - (v + gA), G.BOTTOM_RIGHT) : new m(t.left + t.width - (H + eA), t.top + t.height - (v + gA)), this.bottomLeftContentBox = g > 0 || u > 0 ? X(t.left + b + Y, t.top + U, Math.max(0, g - (b + Y)), u - (v + gA), G.BOTTOM_LEFT) : new m(t.left + b + Y, t.top + t.height - (v + gA));
};
(function(e) {
...
var X = function(e, A, t, r, n) {
  ...
  switch (n) {
    case G.TOP_LEFT:
      return new Et(new m(e, B), new m(e, B - i), new m(c - o, A), new m(c, A));
    case G.TOP_RIGHT:
      return new Et(new m(e, A), new m(e + o, A), new m(c, B - i), new m(c, B));
    case G.BOTTOM_RIGHT:
      return new Et(new m(c, A), new m(c, A + i), new m(e + o, B), new m(e, B));
    case G.BOTTOM_LEFT:
    default:
      return new Et(new m(c, B), new m(c - o, B), new m(e, A + i), new m(e, A));
  }
}, Zt = function(e) {
  ...
  function e(A, t) {
    if (this.container = A, this.parent = t, this.effects = [], this.curves = new YB(this.container), this.container.styles.opacity < 1 && this.effects.push(new jB(this.container.styles.opacity)), this.container.styles.transform !== null) {
      ...
      this.effects.push(new WB(r, n, s));
    }
    if (this.container.styles.overflowX !== 0) {
      var o = Zt(this.curves), i = qt(this.curves);
      Ss(o, i) ? this.effects.push(new bt(o, 6)) : (this.effects.push(new bt(o, 2)), this.effects.push(new bt(i, 4)));
    }
  }
    ...
    for (var t = [2, 3].indexOf(this.container.styles.position) === -1, r = this.parent, n = this.effects.slice(0); r; ) {
      ...
      if (t || r.container.styles.position !== 0 || !r.parent) {
        if (n.unshift.apply(n, s), t = [2, 3].indexOf(r.container.styles.position) === -1, r.container.styles.overflowX !== 0) {
          var o = Zt(r.curves), i = qt(r.curves);
          Ss(o, i) || n.unshift(new bt(i, 6));
        }
      } else
        n.unshift.apply(n, s);
      r = r.parent;
  ...
  e.container.elements.forEach(function(n) {
    var s = nA(n.flags, 4), o = nA(n.flags, 2), i = new Po(n, e);
    nA(n.styles.display, 2048) && r.push(i);
    var c = nA(n.flags, 8) ? [] : r;
    if (s || o) {
      var B = s || n.styles.isPositioned() ? t : A, a = new Vo(i);
  ...
  for (var t = e instanceof jr ? e.start : 1, r = e instanceof jr && e.reversed, n = 0; n < A.length; n++) {
    var s = A[n];
    s.container instanceof bo && typeof s.container.value == "number" && s.container.value !== 0 && (t = s.container.value), s.listValue = et(t, s.container.styles.listStyleType, !0), t += r ? -1 : 1;
  }
}, Ds = function(e, A) {
  switch (A) {
    case 0:
  ...
  var r = function(B, a) {
    return B === 0 ? a.bounds : B === 2 ? zt(a) : Ts(a);
  }(ve(e.styles.backgroundOrigin, A), e), n = function(B, a) {
    return B === 0 ? a.bounds : B === 2 ? zt(a) : Ts(a);
  }(ve(e.styles.backgroundClip, A), e), s = ZB(ve(e.styles.backgroundSize, A), t, r), o = s[0], i = s[1], c = Xe(ve(e.styles.backgroundPosition, A), r.width - o, r.height - i);
  return [qB(ve(e.styles.backgroundRepeat, A), c, s, r, n), Math.round(r.left + c[0]), Math.round(r.top + c[1]), o, i];
}, Ee = function(e) {
  ...
  if (P(o) && (o.value === Le.CONTAIN || o.value === Le.COVER))
    return kt(s) ? t.width / t.height < s != (o.value === Le.COVER) ? [t.width, t.width / s] : [t.height * s, t.height] : [t.width, t.height];
  var B = kt(r), a = kt(n), l = B || a;
  if (Ee(o) && (!i || Ee(i)))
    return B && a ? [r, n] : c || l ? l && c ? [B ? r : n * s, a ? n : r / s] : [B ? r : t.width, a ? n : t.height] : [t.width, t.height];
  if (c) {
    var d = 0, g = 0;
    return Z(o) ? d = N(o, t.width) : Z(i) && (g = N(i, t.height)), Ee(o) ? d = g * s : i && !Ee(i) || (g = d / s), [d, g];
  }
  var u = null, w = null;
  if (Z(o) ? u = N(o, t.width) : i && Z(i) && (w = N(i, t.height)), u === null || i && !Ee(i) || (w = B && a ? u / r * n : t.height), w !== null && Ee(o) && (u = B && a ? w / n * r : t.width), u !== null && w !== null)
    return [u, w];
  throw new Error("Unable to calculate background-size for element");
}, ve = function(e, A) {
  var t = e[A];
  return t === void 0 ? e[0] : t;
}, qB = function(e, A, t, r, n) {
  ...
  function A(t, r) {
    var n = e.call(this, t, r) || this;
    return n._activeEffects = [], n.canvas = r.canvas ? r.canvas : document.createElement("canvas"), n.ctx = n.canvas.getContext("2d"), r.canvas || (n.canvas.width = Math.floor(r.width * r.scale), n.canvas.height = Math.floor(r.height * r.scale), n.canvas.style.width = r.width + "px", n.canvas.style.height = r.height + "px"), n.fontMetrics = new zB(document), n.ctx.scale(n.options.scale, n.options.scale), n.ctx.translate(-r.x, -r.y), n.ctx.textBaseline = "bottom", n._activeEffects = [], n.context.logger.debug("Canvas renderer initialized (" + r.width + "x" + r.height + ") with scale " + r.scale), n;
  }
  return RA(A, e), A.prototype.applyEffects = function(t) {
    ...
    this.ctx.save(), function(r) {
      ...
      return r.type === 0;
    }(t) && (this.ctx.translate(t.offsetX, t.offsetY), this.ctx.transform(t.matrix[0], t.matrix[1], t.matrix[2], t.matrix[3], t.matrix[4], t.matrix[5]), this.ctx.translate(-t.offsetX, -t.offsetY)), Go(t) && (this.path(t.path), this.ctx.clip()), this._activeEffects.push(t);
    ...
    }).join(""), n = nl(t.fontFamily).join(", "), s = At(t.fontSize) ? "" + t.fontSize.number + t.fontSize.unit : t.fontSize.number + "px";
    ...
    var s = n.naturalWidth || t.intrinsicWidth, o = n.naturalHeight || t.intrinsicHeight;
    if (n && s > 0 && o > 0) {
      var i = zt(t), c = qt(r);
      this.path(c), this.ctx.save(), this.ctx.clip();
      var B = 0, a = 0, l = s, d = o, g = i.left, u = i.top, w = i.width, h = i.height, p = t.styles.objectFit, f = w / h, E = l / d;
      p === 2 ? E > f ? (h = w / E, u += (i.height - h) / 2) : (w = h * E, g += (i.width - w) / 2) : p === 4 ? E > f ? B += (s - (l = d * f)) / 2 : a += (o - (d = l / f)) / 2 : p === 8 ? (l > w ? (B += (l - w) / 2, l = w) : (g += (w - l) / 2, w = l), d > h ? (a += (d - h) / 2, d = h) : (u += (h - d) / 2, h = d)) : p === 16 && ((E > f ? w : h * E) < (l > w ? l : w) ? E > f ? (h = w / E, u += (i.height - h) / 2) : (w = h * E, g += (i.width - w) / 2) : (l > w ? (B += (l - w) / 2, l = w) : (g += (w - l) / 2, w = l), d > h ? (a += (d - h) / 2, d = h) : (u += (h - d) / 2, h = d))), this.ctx.drawImage(n, B, a, l, d, g, u, w, h), this.ctx.restore();
    }
  }, A.prototype.renderNodeContent = function(t) {
    return fA(this, void 0, void 0, function() {
      var r, n, s, o, i, c, B, a, l, d, g, u, w, h, p, f, E, U;
      return QA(this, function(C) {
        switch (C.label) {
          ...
          case 8:
            if (r instanceof yo && this.renderReplacedElement(r, n, r.canvas), !(r instanceof Eo))
              return [3, 12];
            C.label = 9;
          case 9:
          ...
          case 12:
            return r instanceof vo && r.tree ? [4, new A(this.context, { scale: this.options.scale, backgroundColor: r.backgroundColor, x: 0, y: 0, width: r.width, height: r.height }).render(r.tree)] : [3, 14];
          case 13:
          ...
          case 14:
            if (r instanceof fn && (a = Math.min(r.bounds.width, r.bounds.height), r.type === Jt ? r.checked && (this.ctx.save(), this.path([new m(r.bounds.left + 0.39363 * a, r.bounds.top + 0.79 * a), new m(r.bounds.left + 0.16 * a, r.bounds.top + 0.5549 * a), new m(r.bounds.left + 0.27347 * a, r.bounds.top + 0.44071 * a), new m(r.bounds.left + 0.39694 * a, r.bounds.top + 0.5649 * a), new m(r.bounds.left + 0.72983 * a, r.bounds.top + 0.23 * a), new m(r.bounds.left + 0.84 * a, r.bounds.top + 0.34085 * a), new m(r.bounds.left + 0.39363 * a, r.bounds.top + 0.79 * a)]), this.ctx.fillStyle = oA(ms), this.ctx.fill(), this.ctx.restore()) : r.type === Yt && r.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(r.bounds.left + a / 2, r.bounds.top + a / 2, a / 4, 0, 2 * Math.PI, !0), this.ctx.fillStyle = oA(ms), this.ctx.fill(), this.ctx.restore())), Al(r) && r.value.length) {
              switch (l = this.createFontStyle(s), E = l[0], d = l[1], g = this.fontMetrics.getMetrics(E, d).baseline, this.ctx.font = E, this.ctx.fillStyle = oA(s.color), this.ctx.textBaseline = "alphabetic", this.ctx.textAlign = tl(r.styles.textAlign), U = zt(r), u = 0, r.styles.textAlign) {
                case 1:
                  u += U.width / 2;
                  break;
                case 2:
          ...
          case 18:
            return [3, 20];
          case 19:
            t.listValue && r.styles.listStyleType !== -1 && (E = this.createFontStyle(s)[0], this.ctx.font = E, this.ctx.fillStyle = oA(s.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = "right", U = new se(r.bounds.left, r.bounds.top + N(r.styles.paddingTop, r.bounds.width), r.bounds.width, ls(s.lineHeight, s.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new ze(t.listValue, U), s.letterSpacing, ls(s.lineHeight, s.fontSize.number) / 2 + 2), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"), C.label = 20;
          case 20:
            return [2];
        }
      });
        ...
        switch (B.label) {
          case 0:
            r = t.styles.backgroundImage.length - 1, n = function(a) {
              var l, d, g, u, w, h, p, f, E, U, C, H, v, b, _, eA, gA, Y, tA, sA, EA, aA, pA, vA, FA, IA, GA, VA, xA, bA, zA;
              return QA(this, function(AA) {
                switch (AA.label) {
                  case 0:
                    if (a.type !== 0)
                      return [3, 5];
                    l = void 0, d = a.url, AA.label = 1;
                  case 1:
                    return AA.trys.push([1, 3, , 4]), [4, s.context.cache.match(d)];
                  case 2:
                    return l = AA.sent(), [3, 4];
                  case 3:
                    return AA.sent(), s.context.logger.error("Error loading background-image " + d), [3, 4];
                  case 4:
                    return l && (g = Ir(t, r, [l.width, l.height, l.width / l.height]), eA = g[0], aA = g[1], pA = g[2], tA = g[3], sA = g[4], b = s.ctx.createPattern(s.resizeImage(l, tA, sA), "repeat"), s.renderRepeat(eA, b, aA, pA)), [3, 6];
                  case 5:
                    a.type === 1 ? (u = Ir(t, r, [null, null, null]), eA = u[0], aA = u[1], pA = u[2], tA = u[3], sA = u[4], w = La(a.angle, tA, sA), h = w[0], p = w[1], f = w[2], E = w[3], U = w[4], (C = document.createElement("canvas")).width = tA, C.height = sA, H = C.getContext("2d"), v = H.createLinearGradient(p, E, f, U), cs(a.stops, h).forEach(function(L) {
                      return v.addColorStop(L.stop, oA(L.color));
                    }), H.fillStyle = v, H.fillRect(0, 0, tA, sA), tA > 0 && sA > 0 && (b = s.ctx.createPattern(C, "repeat"), s.renderRepeat(eA, b, aA, pA))) : function(L) {
                      return L.type === 2;
                    }(a) && (_ = Ir(t, r, [null, null, null]), eA = _[0], gA = _[1], Y = _[2], tA = _[3], sA = _[4], EA = a.position.length === 0 ? [Qn] : a.position, aA = N(EA[0], tA), pA = N(EA[EA.length - 1], sA), vA = function(L, D, M, wA, hA) {
                      var W = 0, cA = 0;
                      switch (L.size) {
                        case 0:
                        ...
                        case 2:
                          if (L.shape === 0)
                            W = cA = Math.min(MA(D, M), MA(D, M - hA), MA(D - wA, M), MA(D - wA, M - hA));
                          else if (L.shape === 1) {
                            var PA = Math.min(Math.abs(M), Math.abs(M - hA)) / Math.min(Math.abs(D), Math.abs(D - wA)), T = Bs(wA, hA, D, M, !0), V = T[0], I = T[1];
                            cA = PA * (W = MA(V - D, (I - M) / PA));
                          }
                          break;
                        case 1:
                        ...
                        case 3:
                          if (L.shape === 0)
                            W = cA = Math.max(MA(D, M), MA(D, M - hA), MA(D - wA, M), MA(D - wA, M - hA));
                          else if (L.shape === 1) {
                            PA = Math.max(Math.abs(M), Math.abs(M - hA)) / Math.max(Math.abs(D), Math.abs(D - wA));
                            var rA = Bs(wA, hA, D, M, !1);
                            V = rA[0], I = rA[1], cA = PA * (W = MA(V - D, (I - M) / PA));
                          }
                      }
                      return Array.isArray(L.size) && (W = N(L.size[0], wA), cA = L.size.length === 2 ? N(L.size[1], hA) : W), [W, cA];
                    }(a, aA, pA, tA, sA), FA = vA[0], IA = vA[1], FA > 0 && IA > 0 && (GA = s.ctx.createRadialGradient(gA + aA, Y + pA, 0, gA + aA, Y + pA, FA), cs(a.stops, 2 * FA).forEach(function(L) {
                      return GA.addColorStop(L.stop, oA(L.color));
                    }), s.path(eA), s.ctx.fillStyle = GA, FA !== IA ? (VA = t.bounds.left + 0.5 * t.bounds.width, xA = t.bounds.top + 0.5 * t.bounds.height, zA = 1 / (bA = IA / FA), s.ctx.save(), s.ctx.translate(VA, xA), s.ctx.transform(1, 0, 0, bA, 0, 0), s.ctx.translate(-VA, -xA), s.ctx.fillRect(gA, zA * (Y - xA) + xA, tA, sA * zA), s.ctx.restore()) : s.ctx.fill())), AA.label = 6;
                  case 6:
                    return r--, [2];
                }
              });
    ...
    return fA(this, void 0, void 0, function() {
      return QA(this, function(s) {
        return this.path(Ds(n, r)), this.ctx.fillStyle = oA(t), this.ctx.fill(), [2];
      });
    });
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(d) {
        switch (d.label) {
          case 0:
            return this.applyEffects(t.getEffects(2)), r = t.container.styles, n = !le(r.backgroundColor) || r.backgroundImage.length, s = [{ style: r.borderTopStyle, color: r.borderTopColor, width: r.borderTopWidth }, { style: r.borderRightStyle, color: r.borderRightColor, width: r.borderRightWidth }, { style: r.borderBottomStyle, color: r.borderBottomColor, width: r.borderBottomWidth }, { style: r.borderLeftStyle, color: r.borderLeftColor, width: r.borderLeftWidth }], o = el(ve(r.backgroundClip, 0), t.curves), n || r.boxShadow.length ? (this.ctx.save(), this.path(o), this.ctx.clip(), le(r.backgroundColor) || (this.ctx.fillStyle = oA(r.backgroundColor), this.ctx.fill()), [4, this.renderBackgroundImage(t.container)]) : [3, 2];
          case 1:
            d.sent(), this.ctx.restore(), r.boxShadow.slice(0).reverse().forEach(function(g) {
              l.ctx.save();
              var u, w, h, p, f, E = Zt(t.curves), U = g.inset ? 0 : 1e4, C = (u = E, w = -U + (g.inset ? 1 : -1) * g.spread.number, h = (g.inset ? 1 : -1) * g.spread.number, p = g.spread.number * (g.inset ? -2 : 2), f = g.spread.number * (g.inset ? -2 : 2), u.map(function(H, v) {
                switch (v) {
                  case 0:
                    return H.add(w, h);
                  case 1:
              ...
              g.inset ? (l.path(E), l.ctx.clip(), l.mask(C)) : (l.mask(E), l.ctx.clip(), l.path(C)), l.ctx.shadowOffsetX = g.offsetX.number + U, l.ctx.shadowOffsetY = g.offsetY.number, l.ctx.shadowColor = oA(g.color), l.ctx.shadowBlur = g.blur.number, l.ctx.fillStyle = g.inset ? oA(g.color) : "rgba(0,0,0,1)", l.ctx.fill(), l.ctx.restore();
            }), d.label = 2;
          case 2:
    ...
    return fA(this, void 0, void 0, function() {
      var i, c, B, a, l, d, g, u, w, h, p, f, E, U, C, H;
      return QA(this, function(v) {
        return this.ctx.save(), i = function(b, _) {
          switch (_) {
            case 0:
              return Ht(b.topLeftBorderStroke, b.topRightBorderStroke);
            case 1:
              return Ht(b.topRightBorderStroke, b.bottomRightBorderStroke);
            case 2:
              return Ht(b.bottomRightBorderStroke, b.bottomLeftBorderStroke);
            default:
              return Ht(b.bottomLeftBorderStroke, b.topLeftBorderStroke);
          }
        }(s, n), c = Ds(s, n), o === 2 && (this.path(c), this.ctx.clip()), DA(c[0]) ? (B = c[0].start.x, a = c[0].start.y) : (B = c[0].x, a = c[0].y), DA(c[1]) ? (l = c[1].end.x, d = c[1].end.y) : (l = c[1].x, d = c[1].y), g = Math.abs(n === 0 || n === 2 ? B - l : a - d), this.ctx.beginPath(), o === 3 ? this.formatPath(i) : this.formatPath(c.slice(0, 2)), u = r < 3 ? 3 * r : 2 * r, w = r < 3 ? 2 * r : r, o === 3 && (u = r, w = r), h = !0, g <= 2 * u ? h = !1 : g <= 2 * u + w ? (u *= p = g / (2 * u + w), w *= p) : (f = Math.floor((g + w) / (u + w)), E = (g - f * u) / (f - 1), w = (U = (g - (f + 1) * u) / f) <= 0 || Math.abs(w - E) < Math.abs(w - U) ? E : U), h && (o === 3 ? this.ctx.setLineDash([0, u + w]) : this.ctx.setLineDash([u, w])), o === 3 ? (this.ctx.lineCap = "round", this.ctx.lineWidth = r) : this.ctx.lineWidth = 2 * r + 1.1, this.ctx.strokeStyle = oA(t), this.ctx.stroke(), this.ctx.setLineDash([]), o === 2 && (DA(c[0]) && (C = c[3], H = c[0], this.ctx.beginPath(), this.formatPath([new m(C.end.x, C.end.y), new m(H.start.x, H.start.y)]), this.ctx.stroke()), DA(c[1]) && (C = c[1], H = c[2], this.ctx.beginPath(), this.formatPath([new m(C.end.x, C.end.y), new m(H.start.x, H.start.y)]), this.ctx.stroke())), this.ctx.restore(), [2];
      });
    });
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(n) {
        switch (n.label) {
          case 0:
            return this.options.backgroundColor && (this.ctx.fillStyle = oA(this.options.backgroundColor), this.ctx.fillRect(this.options.x, this.options.y, this.options.width, this.options.height)), s = new Po(t, null), o = new Vo(s), An(s, o, o, i = []), _o(s.container, i), r = o, [4, this.renderStack(r)];
          case 1:
  ...
  return e instanceof ko || e instanceof Ho || e instanceof fn && e.type !== Yt && e.type !== Jt;
}, el = function(e, A) {
  switch (e) {
    case 0:
      return Zt(A);
...
}, rl = ["-apple-system", "system-ui"], nl = function(e) {
  return /iPhone OS 15_(0|1)/.test(window.navigator.userAgent) ? e.filter(function(A) {
    return rl.indexOf(A) === -1;
  }) : e;
}, sl = function(e) {
  function A(t, r) {
    var n = e.call(this, t, r) || this;
  ...
  return RA(A, e), A.prototype.render = function(t) {
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(s) {
        switch (s.label) {
          case 0:
            return r = Wr(this.options.width * this.options.scale, this.options.height * this.options.scale, this.options.scale, this.options.scale, t), [4, ol(r)];
          case 1:
  ...
  function e(A, t) {
    var r;
    this.windowBounds = t, this.instanceName = "#" + e.instanceCount++, this.logger = new il({ id: this.instanceName, enabled: A.logging }), this.cache = (r = A.cache) !== null && r !== void 0 ? r : new GB(this, A);
  }
  return e.instanceCount = 1, e;
}();
typeof window < "u" && Ro.setContext(window);
var cl = function(e, A) {
  return fA(void 0, void 0, void 0, function() {
    var t, r, n, s, o, i, c, B, a, l, d, g, u, w, h, p, f, E, U, C, H, v, b, _, eA, gA, Y, tA, sA, EA, aA, pA, vA, FA, IA, GA, VA, xA;
    return QA(this, function(bA) {
      switch (bA.label) {
        case 0:
          ...
          return n = { allowTaint: (v = A.allowTaint) !== null && v !== void 0 && v, imageTimeout: (b = A.imageTimeout) !== null && b !== void 0 ? b : 15e3, proxy: A.proxy, useCORS: (_ = A.useCORS) !== null && _ !== void 0 && _ }, s = Tr({ logging: (eA = A.logging) === null || eA === void 0 || eA, cache: A.cache }, n), o = { windowWidth: (gA = A.windowWidth) !== null && gA !== void 0 ? gA : r.innerWidth, windowHeight: (Y = A.windowHeight) !== null && Y !== void 0 ? Y : r.innerHeight, scrollX: (tA = A.scrollX) !== null && tA !== void 0 ? tA : r.pageXOffset, scrollY: (sA = A.scrollY) !== null && sA !== void 0 ? sA : r.pageYOffset }, i = new se(o.scrollX, o.scrollY, o.windowWidth, o.windowHeight), c = new al(s, i), B = (EA = A.foreignObjectRendering) !== null && EA !== void 0 && EA, a = { allowTaint: (aA = A.allowTaint) !== null && aA !== void 0 && aA, onclone: A.onclone, ignoreElements: A.ignoreElements, inlineImages: B, copyStyles: B }, c.logger.debug("Starting document clone with size " + i.width + "x" + i.height + " scrolled to " + -i.left + "," + -i.top), l = new Ks(c, e, a), (d = l.clonedReferenceElement) ? [4, l.toIFrame(t, i)] : [2, Promise.reject("Unable to find element in cloned iframe")];
        case 1:
          return g = bA.sent(), u = Un(d) || d.tagName === "HTML" ? function(zA) {
            var AA = zA.body, L = zA.documentElement;
            if (!AA || !L)
              throw new Error("Unable to get document size");
            var D = Math.max(Math.max(AA.scrollWidth, L.scrollWidth), Math.max(AA.offsetWidth, L.offsetWidth), Math.max(AA.clientWidth, L.clientWidth)), M = Math.max(Math.max(AA.scrollHeight, L.scrollHeight), Math.max(AA.offsetHeight, L.offsetHeight), Math.max(AA.clientHeight, L.clientHeight));
            return new se(0, 0, D, M);
          }(d.ownerDocument) : sr(c, d), w = u.width, h = u.height, p = u.left, f = u.top, E = Bl(c, d, A.backgroundColor), U = { canvas: A.canvas, backgroundColor: E, scale: (vA = (pA = A.scale) !== null && pA !== void 0 ? pA : r.devicePixelRatio) !== null && vA !== void 0 ? vA : 1, x: ((FA = A.x) !== null && FA !== void 0 ? FA : 0) + p, y: ((IA = A.y) !== null && IA !== void 0 ? IA : 0) + f, width: (GA = A.width) !== null && GA !== void 0 ? GA : Math.ceil(w), height: (VA = A.height) !== null && VA !== void 0 ? VA : Math.ceil(h) }, B ? (c.logger.debug("Document cloned, using foreign object rendering"), [4, new sl(c, U).render(d)]) : [3, 3];
        case 2:
          return C = bA.sent(), [3, 5];
        case 3:
          return c.logger.debug("Document cloned, element located at " + p + "," + f + " with size " + w + "x" + h + " using computed rendering"), c.logger.debug("Starting DOM parsing"), H = xo(c, d), E === H.styles.backgroundColor && (H.styles.backgroundColor = ne.TRANSPARENT), c.logger.debug("Starting renderer for element at " + U.x + "," + U.y + " with size " + U.width + "x" + U.height), [4, new $B(c, U).render(H)];
        case 4:
          C = bA.sent(), bA.label = 5;
        case 5:
          return ((xA = A.removeContainer) === null || xA === void 0 || xA) && (Ks.destroy(g) || c.logger.error("Cannot detach cloned iframe as it is not in the DOM anymore")), c.logger.debug("Finished rendering"), [2, C];
      }
    });
  });
}, Bl = function(e, A, t) {
  var r = A.ownerDocument, n = r.documentElement ? je(e, getComputedStyle(r.documentElement).backgroundColor) : ne.TRANSPARENT, s = r.body ? je(e, getComputedStyle(r.body).backgroundColor) : ne.TRANSPARENT, o = typeof t == "string" ? je(e, t) : t === null ? ne.TRANSPARENT : 4294967295;
...
class Fn {
  async captureScreenshot() {
    try {
      ...
      return (await (t = document.body, r = { x: o, y: i, width: n, height: s, scrollX: 0, scrollY: 0, allowTaint: !0, useCORS: !0 }, r === void 0 && (r = {}), cl(t, r))).toDataURL();
    } catch (n) {
      A = n.message, console.error(`${nr} ${A}`);
    }
    var A, t, r;
    return "";
  }
...
}, Xo = "data:image/svg+xml,%3csvg%20width='23'%20height='23'%20viewBox='0%200%2023%2023'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cg%20clip-path='url(%23clip0_15050_29400)'%3e%3cpath%20d='M11.3994%207.80005V15'%20stroke='%238E8E93'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M14.9998%2011.4001H7.7998'%20stroke='%238E8E93'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/g%3e%3cdefs%3e%3cclipPath%20id='clip0_15050_29400'%3e%3crect%20width='21.6'%20height='21.6'%20fill='white'%20transform='translate(0.599609%200.600098)'/%3e%3c/clipPath%3e%3c/defs%3e%3c/svg%3e", Ms = ({ img: e, text: A, onClick: t }) => {
...
async function jo(e, A) {
  if (!e)
    return;
  const t = { data: e, type: A, name: Yo(A) };
  await eo(t);
}
const Zo = async () => {
  J("Returning to Shake.");
  const e = iA.localStorage.getShakeState(), A = await rr(), t = ni(e, A);
  document.body.appendChild(t), iA.localStorage.setShakeOpened(!0);
}, rt = (e = !0) => {
  J("Shake closed");
  const A = iA.localStorage;
  e && (Ml(), A.setShakeState(null), new Promise((r, n) => {
    const s = indexedDB.open(st, 1);
    s.onerror = function() {
      n("Error opening database");
    }, s.onsuccess = function(o) {
  ...
  const e = ((A, t) => {
    ...
    return ue(o), o.appendChild(n), ll(n, t), s;
...
const dl = async (e) => {
  ...
  return e.onclick = async (n) => {
    n.stopPropagation(), await $o() ? new Jo(q().shake_sdk_dialog_attachment_limit_message, 4e3, q().shake_sdk_dialog_attachment_limit_title) : r();
  }, t;
  ...
  return c.classList.add("shake-sdk-attachments-items"), e.forEach((B) => {
    const a = ((l, d, g) => {
      ...
      }, w = l.type == uA.IMAGE ? ZA(l.data) : dr({ src: l.data + "#t=3", autoplay: !0 }), w.classList.add("shake-sdk-attachment-item-thumbnail");
      const h = mn();
      h.classList.add("shake-sdk-attachment-item-card"), h.appendChild(w), h.appendChild(u);
      const p = l.type == uA.IMAGE ? q().shake_sdk_dialog_add_attachment_type_image : q().shake_sdk_dialog_add_attachment_type_video, f = wl(p), E = S();
      E.classList.add("shake-sdk-attachment-item-title"), E.appendChild(f);
      const U = S();
      return U.classList.add("shake-sdk-attachment-item"), U.onclick = () => d(l), U.appendChild(h), U.appendChild(E), U;
    })(B, s, o);
    ...
    const a = S();
    return a.classList.add("shake-sdk-attachments-add-item"), a.appendChild(B), a.appendChild(gl(B)), a;
  })()), i(), c;
}, Ql = (e) => {
  const A = S();
  ...
  const t = ZA(e.icon), r = ro(e.text), n = document.createElement("button");
  ...
  const t = hn(e), r = ro(A), n = document.createElement("div");
...
})(q().shake_sdk_dialog_attachment_limit_title, q().shake_sdk_dialog_attachment_limit_message), ti = "data:image/svg+xml,%3csvg%20width='50'%20height='51'%20viewBox='0%200%2050%2051'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M20.834%2021.5598L29.1673%2029.8931'%20stroke='%23FFFFFF'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M29.1673%2021.56L20.834%2029.8933'%20stroke='%23FFFFFF'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e", Fl = (e) => {
  J(`Opening image: ${e.name}`), document.body.appendChild(((A) => {
    const t = $t({ image: ti, onClick: () => {
      i.remove();
    } }), r = S();
  ...
  const A = iA.attachmentsManager, t = /* @__PURE__ */ new Map(), r = (i) => {
    i.type == uA.IMAGE ? Fl(i) : i.type == uA.VIDEO && ml(i);
  }, n = (i) => {
  ...
  s.classList.add("shake-sdk-attachments-items-small"), e.forEach((i) => {
    const c = ((B, a, l) => {
      ...
      const g = B.type == uA.IMAGE ? ZA(B.data) : dr({ src: B.data + "#t=3", autoplay: !0 });
  ...
  const o = ((i) => {
    ...
    await $o() ? rn(Ul()) : rn((() => {
      const i = [{ text: q().shake_sdk_dialog_add_attachment_grab_screenshot, icon: "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='54'%20height='54'%3e%3cpath%20fill='%2300000000'%20d='M13.5,6.75h-2.25c-2.485,0%20-4.5,2.015%20-4.5,4.5v2.25M40.5,47.25h2.25c2.485,0%204.5,-2.015%204.5,-4.5V40.5M6.75,40.5v2.25c0,2.485%202.015,4.5%204.5,4.5h2.25M47.25,13.5v-2.25c0,-2.485%20-2.015,-4.5%20-4.5,-4.5H40.5'%20stroke-width='3.38'%20stroke='%234CD266'/%3e%3c/svg%3e", onClick: qo }, { text: q().shake_sdk_dialog_add_attachment_record_screen, icon: "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='54'%20height='54'%3e%3cpath%20fill='%2300000000'%20d='M37.487,32.702L32.57,29.67v-5.342l4.918,-3.03c0.382,-0.236%200.861,-0.247%201.253,-0.028%200.392,0.218%200.635,0.632%200.635,1.08v9.297c0,0.45%20-0.243,0.863%20-0.635,1.081%20-0.392,0.219%20-0.871,0.208%20-1.253,-0.027z'%20stroke-width='3.375'%20stroke='%23FF9C0A'/%3e%3cpath%20fill='%2300000000'%20d='M16.275,18.956L30.919,18.956A1.65,1.65%200,0%201,32.569%2020.606L32.569,33.393A1.65,1.65%200,0%201,30.919%2035.043L16.275,35.043A1.65,1.65%200,0%201,14.625%2033.393L14.625,20.606A1.65,1.65%200,0%201,16.275%2018.956z'%20stroke-width='3.375'%20stroke='%23FF9C0A'/%3e%3cpath%20fill='%2300000000'%20d='M11.75,6.75L42.25,6.75A5,5%200,0%201,47.25%2011.75L47.25,42.25A5,5%200,0%201,42.25%2047.25L11.75,47.25A5,5%200,0%201,6.75%2042.25L6.75,11.75A5,5%200,0%201,11.75%206.75z'%20stroke-width='3.375'%20stroke='%23FF9C0A'/%3e%3c/svg%3e", onClick: zo }];
      return ei(q().shake_sdk_dialog_add_attachment, i);
    })());
  });
  return s.appendChild(o), s;
}, ri = () => {
  new Jo(q().shake_sdk_dialog_ticket_sent_message, 4e3, q().shake_sdk_dialog_ticket_sent_title);
}, El = (e, A) => [{ type: Gt.TITLE, value: e, label: "Title" }, { type: Gt.PICKER, value: A, label: "Ticket type" }], bl = [{ icon: "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='54'%20height='54'%3e%3cpath%20fill='%2300000000'%20d='m40.5,15.75%20l-2.25,4.5%20-3,2.063M11.25,27h6.997M35.752,27h6.998M13.5,6.75h-2.25a4.499,4.499%200,0%200,-4.5%204.5v2.25M40.5,47.25h2.25c2.486,0%204.5,-2.014%204.5,-4.5V40.5M6.75,40.5v2.25c0,2.486%202.014,4.5%204.5,4.5h2.25M47.25,13.5v-2.25c0,-2.486%20-2.014,-4.5%20-4.5,-4.5H40.5M13.5,15.75l2.25,4.5%203,2.063M27.999,38.25h-2a6.75,6.75%200,0%201,-6.75%20-6.75v-6.75c0,-2.486%202.014,-4.5%204.5,-4.5h6.5c2.486,0%204.5,2.014%204.5,4.5v6.75a6.75,6.75%200,0%201,-6.75%206.75zM13.5,38.25l2.25,-4.5%203,-2.063M40.5,38.25l-2.25,-4.5%20-3,-2.063M31.5,20.25h-9v-4.5a2.25,2.25%200,0%201,2.25%20-2.25h4.5a2.25,2.25%200,0%201,2.25%202.25v4.5z'%20stroke-width='3.38'%20stroke='%23B77DFF'/%3e%3c/svg%3e", value: Ye.BUG, label: q().shake_sdk_new_ticket_feedback_type_bug }, { icon: "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='54'%20height='54'%3e%3cpath%20fill='%2300000000'%20d='M42.75,47.25h-31.5a4.499,4.499%200,0%201,-4.5%20-4.5v-31.5c0,-2.486%202.014,-4.5%204.5,-4.5h31.5c2.486,0%204.5,2.014%204.5,4.5v31.5c0,2.486%20-2.014,4.5%20-4.5,4.5z'%20stroke-width='3.38'%20stroke='%23FF9F0A'/%3e%3cpath%20fill='%2300000000'%20d='M27,29.813v-0.563c0,-1.838%201.136,-2.835%202.275,-3.6%201.111,-0.75%202.225,-1.726%202.225,-3.526%200,-2.486%20-2.014,-4.5%20-4.5,-4.5a4.499,4.499%200,0%200,-4.5%204.5M26.998,36a0.563,0.563%200,1%200,0.005%201.125,0.563%200.563,0%200,0%20-0.005,-1.125'%20stroke-width='3.38'%20stroke='%23FF9F0A'/%3e%3c/svg%3e", value: Ye.QUESTION, label: q().shake_sdk_new_ticket_feedback_type_question }, { icon: "data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='54'%20height='54'%3e%3cpath%20fill='%2300000000'%20d='M31.275,47.25h0a20.507,20.507%200,0%200,15.417%20-15.417M38.25,22.5V9M31.5,15.75H45M6.75,22.725h0A20.504,20.504%200,0%201,22.167%207.304M22.167,47.25h0A20.511,20.511%200,0%201,6.75%2031.833'%20stroke-width='3.38'%20stroke='%23D75ED7'/%3e%3c/svg%3e", value: Ye.SUGGESTION, label: q().shake_sdk_new_ticket_feedback_type_suggestion }], Hl = (e, A) => {
  ...
  const c = ((h = rt, p = !1, f = () => {
    ...
    const E = $t({ image: nn, onClick: () => f() }), U = $t({ image: nn, onClick: h }), C = document.createElement("div");
    return C.classList.add("shake-sdk-toolbar"), p && C.appendChild(E), C.appendChild(U), C;
  })(), B = hn(q().shake_sdk_ticket_form_title);
  B.classList.add("shake-sdk-new-ticket-title"), o.appendChild(B);
  const a = to();
  function l() {
    n = !r.trim() || s, a.disabled = n, d.textContent = s ? q().shake_sdk_ticket_form_submit_button_text_loading : q().shake_sdk_ticket_form_submit_button_text;
  }
  a.disabled = !0, a.onclick = async () => {
    s = !0, l(), await (async ({ feedbackType: h, description: p }) => {
      J("Ticket submitted.");
      const f = De.shakeFeedbackService, E = iA.localStorage.getShakeState(), U = await rr(), C = E.ticket;
      C && (C.tags.push(h), C.custom_fields = El(p, h), await f.sendUserFeedback(C, U)), ri(), rt();
    })({ feedbackType: t, description: r }), s = !1;
  }, a.classList.add("shake-sdk-submit-button");
  const d = no(q().shake_sdk_ticket_form_submit_button_text);
  a.appendChild(d);
  const g = fl({ label: q().shake_sdk_new_ticket_feedback_type_title, items: bl, onSelectionChange: (h) => {
    t = h, e.feedbackType = h, iA.localStorage.setShakeState(e);
  }, selectedValue: t });
  i.appendChild(c), i.appendChild(B), i.appendChild(g);
  const u = (({ onChange: h, maxLength: p, value: f, label: E }) => {
    const U = S();
    U.classList.add("shake-sdk-textarea-container");
    const C = document.createElement("label");
    C.textContent = E, C.classList.add("shake-sdk-textarea-label");
    ...
    return H.classList.add("shake-sdk-textarea"), H.rows = 12, H.textContent = f || null, H.addEventListener("input", function(v) {
      ...
      p && b.length > p && (b = b.slice(0, p), v.target.value = b), h(v.target.value);
    }), U.appendChild(C), U.appendChild(H), U;
  })({ onChange: (h) => {
    r = h, e.description = h, iA.localStorage.setShakeState(e), l();
  }, maxLength: 1e4, value: r, label: q().shake_sdk_ticket_form_description_placeholder });
...
var xr, Kr, sn = { exports: {} };
xr = sn, Kr = sn.exports, function(e, A) {
  var t = "function", r = "undefined", n = "object", s = "string", o = "major", i = "model", c = "name", B = "type", a = "vendor", l = "version", d = "architecture", g = "console", u = "mobile", w = "tablet", h = "smarttv", p = "wearable", f = "embedded", E = "Amazon", U = "Apple", C = "ASUS", H = "BlackBerry", v = "Browser", b = "Chrome", _ = "Firefox", eA = "Google", gA = "Huawei", Y = "LG", tA = "Microsoft", sA = "Motorola", EA = "Opera", aA = "Samsung", pA = "Sharp", vA = "Sony", FA = "Xiaomi", IA = "Zebra", GA = "Facebook", VA = "Chromium OS", xA = "Mac OS", bA = function(T) {
    for (var V = {}, I = 0; I < T.length; I++)
      V[T[I].toUpperCase()] = T[I];
    return V;
  }, zA = function(T, V) {
    return typeof T === s && AA(V).indexOf(AA(T)) !== -1;
  }, AA = function(T) {
    ...
    return this.getBrowser = function() {
      ...
      var k = {};
      return k[c] = A, k[l] = A, D.call(k, rA, R.os), $A && !k[c] && _A && _A.platform != "Unknown" && (k[c] = _A.platform.replace(/chrome os/i, VA).replace(/macos/i, xA)), k;
  ...
  W.VERSION = "1.0.37", W.BROWSER = bA([c, l, o]), W.CPU = bA([d]), W.DEVICE = bA([i, a, B, g, u, h, w, p, f]), W.ENGINE = W.OS = bA([c, l]), xr.exports && (Kr = xr.exports = W), Kr.UAParser = W;
...
F(xe, "metadata", {});
async function si() {
  const e = new kl.UAParser(navigator.userAgent), A = await xl().then((t) => t);
  return { timezone: Intl.DateTimeFormat().resolvedOptions().timeZone, issue_reported_time: en((/* @__PURE__ */ new Date()).toString()), os: Rt.WEB, device: vl(), browser_name: e.getBrowser().name, browser_version: e.getBrowser().version, current_view: window.location.pathname, screen_height: Rs().height, screen_width: Rs().width, metadata_: xe.metadata, sdk_version: wn, platform: Rt.WEB, report_type: Ao.MANUAL, screen_density: window.devicePixelRatio || 1, locale: window.navigator.language || null, os_version: e.getOS().version, os_name: e.getOS().name, device_orientation: Il(), battery_level: A == null ? void 0 : A.level, battery_status: A != null && A.charging ? 1 : 0, font_scale: Kl(), network_type: Ll(), permissions: await Ol().then((t) => t), browser_height: Gs().height, browser_width: Gs().width, cookies_enabled: Sl(), is_mobile: Dl(), cpu_arch: e.getCPU().architecture, app_version: "1.0", tags: [] };
}
function vl() {
...
}, Sl = () => "cookieEnabled" in navigator && navigator.cookieEnabled || null, Dl = () => {
  var e;
  ...
  if (iA.localStorage.isSDKEnabled())
    if (an.config.floatingButtonEnabled) {
      const e = (() => {
        ...
        const r = no(q().shake_sdk_main_button_title);
...
}, Vs = 5120, Vl = { takeScreenshot: !0, showSuccessMessage: !1 }, Pl = (e) => {
  const A = [];
  return e && A.push({ type: Gt.TITLE, value: e, label: "Title" }), A;
}, CA = class CA {
        ...
        if (t)
          if (r) {
            if (TA.clientId = A, TA.clientSecret = t, TA.bundleId = r, this.localStorage.isSDKEnabled())
              return on(), void qn("Shake started.");
            await this.shakeAuthService.authenticate(A, t).finally(() => this.isLoading = !1), this.localStorage.isSDKEnabled() && (on(), qn("Shake started."));
          } else
            Ce("Shake not started. Bundle id is empty.");
        else
          Ce("Cannot start Shake. Client secret is empty.");
      else
        Ce("Cannot start Shake. Client id is empty.");
  }
};
F(CA, "config", new Gl()), F(CA, "isLoading", !1), F(CA, "localStorage", iA.localStorage), F(CA, "shakeAuthService", De.shakeAuthService), F(CA, "show", async () => await CA.ifSDKEnabled(async () => {
  await oi();
})), F(CA, "silentReport", async (A, t) => await CA.ifSDKEnabled(async () => {
  await (async (r, n = Vl) => {
    J("Silent report called.");
    const s = De.shakeFeedbackService, o = [];
    if (n.takeScreenshot) {
      const c = await new Fn().captureScreenshot();
      c && o.push({ data: c, type: uA.IMAGE, name: Yo(uA.IMAGE) });
    }
    const i = await si();
    i.tags.push("silent"), i.custom_fields = Pl(r), await s.sendUserFeedback(i, o), n.showSuccessMessage && ri();
  })(A, t);
})), F(CA, "setMetadata", (A, t) => {
  ((r, n) => {
    if (J(`Set metadata: ${r}`), Object.keys(xe.metadata).length >= 100)
      return void Ce("Cannot set metadata. Limit of 100 items reached.");
    n.length > Vs && (Ce("Truncating metadata value. Value exceeded 5120 chars."), n = n.substring(0, Vs)), xe.metadata[r] = n;
  })(A, t);
}), F(CA, "removeMetadata", (A) => {
  ((t) => {
    J(`Removing metadata: ${t}`), delete xe.metadata[t];
  })(A);
}), F(CA, "clearMetadata", () => {
  J("Clearing metadata"), xe.metadata = {};
}), F(CA, "ifSDKEnabled", async (A) => CA.localStorage.isSDKEnabled() ? (await A(), !0) : (Ce("Please call Shake.start(clientId, clientSecret) before using Shake."), !1));
let an = CA;
export {
  an as default
};
