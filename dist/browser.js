...
var ui = (e, A, t) => A in e ? di(e, A, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[A] = t;
var f = (e, A, t) => (ui(e, typeof A != "symbol" ? A + "" : A, t), t);
import "./main.css";
class yA {
}
...
const { toString: pi } = Object.prototype, { getPrototypeOf: cn } = Object, Tt = (wr = /* @__PURE__ */ Object.create(null), (e) => {
  const A = pi.call(e);
  return wr[A] || (wr[A] = A.slice(8, -1).toLowerCase());
});
var wr;
const jA = (e) => (e = e.toLowerCase(), (A) => Tt(A) === e), tr = (e) => (A) => typeof A === e, { isArray: Ee } = Array, Re = tr("undefined"), Hn = jA("ArrayBuffer"), Ci = tr("string"), LA = tr("function"), kn = tr("number"), it = (e) => e !== null && typeof e == "object", at = (e) => {
  if (Tt(e) !== "object")
    return !1;
  const A = cn(e);
  return !(A !== null && A !== Object.prototype && Object.getPrototypeOf(A) !== null || Symbol.toStringTag in e || Symbol.iterator in e);
}, fi = jA("Date"), Ui = jA("File"), Fi = jA("Blob"), mi = jA("FileList"), yi = jA("URLSearchParams");
...
const Js = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, In = (e) => !Re(e) && e !== Js, Ei = (hr = typeof Uint8Array < "u" && cn(Uint8Array), (e) => hr && e instanceof hr);
var hr;
const bi = jA("HTMLFormElement"), xn = (({ hasOwnProperty: e }) => (A, t) => e.call(A, t))(Object.prototype), Hi = jA("RegExp"), Ln = (e, A) => {
  const t = Object.getOwnPropertyDescriptors(e), r = {};
  Ge(t, (n, s) => {
    let o;
    (o = A(n, s, e)) !== !1 && (r[s] = o || n);
  }), Object.defineProperties(e, r);
}, Qr = "abcdefghijklmnopqrstuvwxyz", Kn = "0123456789", Sn = { DIGIT: Kn, ALPHA: Qr, ALPHA_DIGIT: Qr + Qr.toUpperCase() + Kn }, ki = jA("AsyncFunction"), Q = { isArray: Ee, isArrayBuffer: Hn, isBuffer: function(e) {
...
}, isString: Ci, isNumber: kn, isBoolean: (e) => e === !0 || e === !1, isObject: it, isPlainObject: at, isUndefined: Re, isDate: fi, isFile: Ui, isBlob: Fi, isRegExp: Hi, isFunction: LA, isStream: (e) => it(e) && LA(e.pipe), isURLSearchParams: yi, isTypedArray: Ei, isFileList: mi, forEach: Ge, merge: function e() {
  ...
  return A;
}, kindOf: Tt, kindOfTest: jA, endsWith: (e, A, t) => {
  ...
  for (; (t = e.exec(A)) !== null; )
    r.push(t);
  return r;
}, isHTMLForm: bi, hasOwnProperty: xn, hasOwnProp: xn, reduceDescriptors: Ln, freezeMethods: (e) => {
  Ln(e, (A, t) => {
...
}, toFiniteNumber: (e, A) => (e = +e, Number.isFinite(e) ? e : A), findKey: vn, global: Js, isContextDefined: In, ALPHABET: Sn, generateString: (e = 16, A = Sn.ALPHA_DIGIT) => {
  let t = "";
  const { length: r } = A;
  for (; e--; )
    t += A[Math.random() * r | 0];
  ...
  return t(e, 0);
}, isAsyncFn: ki, isThenable: (e) => e && (it(e) || LA(e)) && LA(e.then) && LA(e.catch) };
...
const vi = Q.toFlatObject(Q, {}, null, function(e) {
...
function Ot(e, A, t) {
  ...
  const a = [], l = Object.assign(vi, { defaultVisitor: B, convertValue: c, isVisitable: pr });
  if (!Q.isObject(e))
...
const js = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 }, xi = { isBrowser: !0, classes: { URLSearchParams: typeof URLSearchParams < "u" ? URLSearchParams : Bn, FormData: typeof FormData < "u" ? FormData : null, Blob: typeof Blob < "u" ? Blob : null }, protocols: ["http", "https", "file", "blob", "url", "data"] }, Zs = typeof window < "u" && typeof document < "u", Li = (Vn = typeof navigator < "u" && navigator.product, Zs && ["ReactNative", "NativeScript", "NS"].indexOf(Vn) < 0);
var Vn;
const Ki = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function", WA = { ...Object.freeze(Object.defineProperty({ __proto__: null, hasBrowserEnv: Zs, hasStandardBrowserEnv: Li, hasStandardBrowserWebWorkerEnv: Ki }, Symbol.toStringTag, { value: "Module" })), ...xi };
function qs(e) {
  function A(t, r, n, s) {
    let o = t[s++];
    if (o === "__proto__")
...
const ln = { transitional: js, adapter: ["xhr", "http"], transformRequest: [function(e, A) {
  ...
  if (n && Q.isHTMLForm(e) && (e = new FormData(e)), Q.isFormData(e))
    return r && r ? JSON.stringify(qs(e)) : e;
...
const dn = ln, Si = Q.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]), Pn = Symbol("internals");
function Te(e) {
...
class vt {
  ...
  set(A, t, r) {
    ...
    return Q.isPlainObject(A) || A instanceof this.constructor ? o(A, t) : Q.isString(A) && (A = A.trim()) && !((i) => /^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(i.trim()))(A) ? o(((i) => {
      ...
      return i && i.split(`
`).forEach(function(d) {
        l = d.indexOf(":"), B = d.substring(0, l).trim().toLowerCase(), a = d.substring(l + 1).trim(), !B || c[B] && Si[B] || (B === "set-cookie" ? c[B] ? c[B].push(a) : c[B] = [a] : c[B] = c[B] ? c[B] + ", " + a : a);
      }), c;
...
const Di = WA.hasStandardBrowserEnv ? { write(e, A, t, r, n, s) {
...
const Ti = WA.hasStandardBrowserEnv ? function() {
...
const Ao = { http: null, xhr: typeof XMLHttpRequest < "u" && function(e) {
  return new Promise(function(A, t) {
    ...
    function d() {
      ...
      (function(w, h, p) {
        const U = p.config.validateStatus;
        p.status && U && !U(p.status) ? h(new K("Request failed with status code " + p.status, [K.ERR_BAD_REQUEST, K.ERR_BAD_RESPONSE][Math.floor(p.status / 100) - 4], p.config, p.request, p)) : w(p);
      })(function(w) {
        A(w), B();
      }, function(w) {
        t(w), B();
    ...
    }, WA.hasStandardBrowserEnv && (c && Q.isFunction(c) && (c = c(e)), c || c !== !1 && Ti(l))) {
      const u = e.xsrfHeaderName && e.xsrfCookieName && Di.read(e.xsrfCookieName);
...
const Nn = (e) => `- ${e}`, Oi = (e) => Q.isFunction(e) || e === null || e === !1, eo = (e) => {
  e = Q.isArray(e) ? e : [e];
  const { length: A } = e;
  let t, r;
  const n = {};
  for (let s = 0; s < A; s++) {
    let o;
    if (t = e[s], r = t, !Oi(t) && (r = Ao[(o = String(t)).toLowerCase()], r === void 0))
...
Z.Axios = xt, Z.CanceledError = nt, Z.CancelToken = Ri, Z.isCancel = zs, Z.VERSION = Mi, Z.toFormData = Ot, Z.AxiosError = K, Z.Cancel = Z.CanceledError, Z.all = function(e) {
...
}, Z.mergeConfig = Ke, Z.AxiosHeaders = te, Z.formToJSON = (e) => qs(Q.isHTMLForm(e) ? new FormData(e) : e), Z.getAdapter = eo, Z.HttpStatusCode = Gi, Z.default = Z;
var Vi = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Pi(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
const _i = Pi(typeof self == "object" ? self.FormData : window.FormData), ee = "shake.sdk.appToken", Yn = "shake.sdk.isAppRegistered", jn = "shake.sdk.isAppActive", Zn = "shake.sdk.isShakeOpened", qn = "shake.sdk.shakeState", zn = "shake.sdk.shakeDeviceId", he = class he {
  constructor(A, t, r, n) {
    f(this, "instance");
    f(this, "instanceAuth");
    f(this, "version");
...
const Ni = ["geolocation", "camera", "microphone", "notifications", "persistent-storage", "screen-wake-lock"];
class Xi {
  constructor() {
    f(this, "ticket", null);
    f(this, "description", "");
...
class Ji {
  constructor(A) {
    ...
    f(this, "getShakeState", () => this.storageProvider.getObject(qn) ?? new Xi());
...
f(xe, "storageProvider", new Yi()), f(xe, "localStorage", new Ji(xe.storageProvider)), f(xe, "attachmentsManager", new Wi());
let iA = xe;
...
class zi {
  constructor() {
    ...
    this.feedbackApi = new Zi(this.baseApiParams), this.filesApi = new qi(this.baseApiParams);
  }
  ...
  convertAttachmentToFile(A) {
    return new File([A.data], A.name, { type: A.data.type });
  }
...
f(Se, "shakeAuthService", new ji()), f(Se, "shakeFeedbackService", new zi());
...
for (var ne = function() {
  ...
  return s;
}, $i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Aa = typeof Uint8Array > "u" ? [] : new Uint8Array(256), Bt = 0; Bt < 64; Bt++)
  Aa[$i.charCodeAt(Bt)] = Bt;
for (var ea = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Ve = typeof Uint8Array > "u" ? [] : new Uint8Array(256), lt = 0; lt < 64; lt++)
  Ve[ea.charCodeAt(lt)] = lt;
...
}(), ra = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", na = typeof Uint8Array > "u" ? [] : new Uint8Array(256), dt = 0; dt < 64; dt++)
  na[ra.charCodeAt(dt)] = dt;
var ie = 10, Or = 13, Pe = 15, ut = 17, Oe = 18, sa = 19, ts = 20, Mr = 21, Me = 22, Ce = 24, kA = 25, _e = 26, Ne = 27, fe = 28, be = 30, gt = 32, wt = 33, Rr = 34, Gr = 35, Ye = 37, Vr = 38, Lt = 39, Kt = 40, rs = 42, oa = [9001, 65288], x = "×", ht = "÷", Pr = function(e, A) {
  var t, r, n, s = function(a) {
    var l, d, g, u, w, h = 0.75 * a.length, p = a.length, U = 0;
    a[a.length - 1] === "=" && (h--, a[a.length - 2] === "=" && h--);
    var H = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && Uint8Array.prototype.slice !== void 0 ? new ArrayBuffer(h) : new Array(h), F = Array.isArray(H) ? H : new Uint8Array(H);
    for (l = 0; l < p; l += 4)
      d = Ve[a.charCodeAt(l)], g = Ve[a.charCodeAt(l + 1)], u = Ve[a.charCodeAt(l + 2)], w = Ve[a.charCodeAt(l + 3)], F[U++] = d << 2 | g >> 4, F[U++] = (15 & g) << 4 | u >> 2, F[U++] = (3 & u) << 6 | 63 & w;
    return H;
  ...
  if (os(s, A) === 8)
    return ht;
  if (Pr.get(e[s]) === 11 || (c === gt || c === wt) && Pr.get(e[i]) === 11 || c === 7 || a === 7 || c === 9 || [ie, Or, Pe].indexOf(c) === -1 && a === 9 || [ut, Oe, sa, Ce, fe].indexOf(a) !== -1 || os(s, A) === Me || Fr(23, Me, s, A) || Fr([ut, Oe], Mr, s, A) || Fr(12, 12, s, A))
    return x;
  if (c === ie)
    return ht;
  if (c === 23 || a === 23)
  ...
  if (a === 16 || c === 16)
    return ht;
  if ([Or, Pe, Mr].indexOf(a) !== -1 || c === 14 || B === 36 && aa.indexOf(c) !== -1 || c === fe && a === 36 || a === ts || $A.indexOf(a) !== -1 && c === kA || $A.indexOf(c) !== -1 && a === kA || c === Ne && [Ye, gt, wt].indexOf(a) !== -1 || [Ye, gt, wt].indexOf(c) !== -1 && a === _e || $A.indexOf(c) !== -1 && ns.indexOf(a) !== -1 || ns.indexOf(c) !== -1 && $A.indexOf(a) !== -1 || [Ne, _e].indexOf(c) !== -1 && (a === kA || [Me, Pe].indexOf(a) !== -1 && A[i + 1] === kA) || [Me, Pe].indexOf(c) !== -1 && a === kA || c === kA && [kA, fe, Ce].indexOf(a) !== -1)
    return x;
  ...
  if (Vr === c && [Vr, Lt, Rr, Gr].indexOf(a) !== -1 || [Lt, Rr].indexOf(c) !== -1 && [Lt, Kt].indexOf(a) !== -1 || [Kt, Gr].indexOf(c) !== -1 && a === Kt || ss.indexOf(c) !== -1 && [ts, _e].indexOf(a) !== -1 || ss.indexOf(a) !== -1 && c === Ne || $A.indexOf(c) !== -1 && $A.indexOf(a) !== -1 || c === Ce && $A.indexOf(a) !== -1 || $A.concat(kA).indexOf(c) !== -1 && a === Me && oa.indexOf(e[i]) === -1 || $A.concat(kA).indexOf(a) !== -1 && c === Oe)
    return x;
  if (c === 41 && a === 41) {
  ...
  var t = function(i, c) {
    ...
    return i.forEach(function(d, g) {
      ...
      if (u === 4 || u === 11) {
        ...
        var w = B[g - 1];
        return ia.indexOf(w) === -1 ? (a.push(a[g - 1]), B.push(w)) : (a.push(g), B.push(be));
      }
...
}, ga = { type: 2 }, wa = { type: 3 }, ha = { type: 4 }, Qa = { type: 13 }, pa = { type: 8 }, Ca = { type: 21 }, fa = { type: 9 }, Ua = { type: 10 }, Fa = { type: 11 }, ma = { type: 12 }, ya = { type: 14 }, Ct = { type: 23 }, Ea = { type: 1 }, ba = { type: 25 }, Ha = { type: 24 }, ka = { type: 26 }, va = { type: 27 }, Ia = { type: 28 }, xa = { type: 29 }, La = { type: 31 }, Nr = { type: 32 }, co = function() {
  function e() {
    this._value = [];
  }
  return e.prototype.write = function(A) {
    ...
    switch (A) {
      ...
      case mA:
        ...
        if (i === mA && c === 62)
          return this.consumeCodePoint(), this.consumeCodePoint(), Ha;
        break;
      case 46:
        if (mr(A, this.peekCodePoint(0), this.peekCodePoint(1)))
          return this.reconsumeCodePoint(A), this.consumeNumericToken();
    ...
    return Qt(A) ? (this.consumeWhiteSpace(), La) : UA(A) ? (this.reconsumeCodePoint(A), this.consumeNumericToken()) : _t(A) ? (this.reconsumeCodePoint(A), this.consumeIdentLikeToken()) : { type: 6, value: z(A) };
    ...
    for (var t = "", r = 0; ; ) {
      ...
      if (n === 10)
        return this._value.splice(0, r), Ea;
      if (n === 92) {
...
}, Da = { hsl: ls, hsla: ls, rgb: Bs, rgba: Bs }, je = function(e, A) {
...
} }, Oa = { name: "background-color", initialValue: "transparent", prefix: !1, type: 3, format: "color" }, Nt = function(e, A) {
...
} }, Ra = { name: "background-image", initialValue: "none", type: 1, prefix: !1, parse: function(e, A) {
  if (A.length === 0)
    return [];
  var t = A[0];
...
} }, Ga = { name: "background-origin", initialValue: "border-box", prefix: !1, type: 1, parse: function(e, A) {
  return A.map(function(t) {
    if (P(t))
      switch (t.value) {
        case "padding-box":
...
} }, Pa = { name: "background-repeat", initialValue: "repeat", prefix: !1, type: 1, parse: function(e, A) {
  return YA(A).map(function(t) {
...
var Xt, Na = { name: "background-size", initialValue: "0", prefix: !1, type: 1, parse: function(e, A) {
  return YA(A).map(function(t) {
    return t.filter(Xa);
  });
} }, Xa = function(e) {
...
}, Ja = ir("top"), Wa = ir("right"), Ya = ir("bottom"), ja = ir("left"), ar = function(e) {
  return { name: "border-radius-" + e, initialValue: "0 0", prefix: !1, type: 1, parse: function(A, t) {
    return lo(t.filter(AA));
  } };
}, Za = ar("top-left"), qa = ar("top-right"), za = ar("bottom-right"), $a = ar("bottom-left"), cr = function(e) {
...
}, Ac = cr("top"), ec = cr("right"), tc = cr("bottom"), rc = cr("left"), Br = function(e) {
  return { name: "border-" + e + "-width", initialValue: "0", type: 0, prefix: !1, parse: function(A, t) {
    return At(t) ? t.number : 0;
  } };
}, nc = Br("top"), sc = Br("right"), oc = Br("bottom"), ic = Br("left"), ac = { name: "color", initialValue: "transparent", prefix: !1, type: 3, format: "color" }, cc = { name: "direction", initialValue: "ltr", prefix: !1, type: 2, parse: function(e, A) {
  return A === "rtl" ? 1 : 0;
} }, Bc = { name: "display", initialValue: "inline-block", prefix: !1, type: 1, parse: function(e, A) {
  ...
  return 0;
}, dc = { name: "float", initialValue: "none", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "left":
      return 1;
    case "right":
  ...
  return 0;
} }, uc = { name: "letter-spacing", initialValue: "0", prefix: !1, type: 0, parse: function(e, A) {
  return A.type === 20 && A.value === "normal" ? 0 : A.type === 17 || A.type === 15 ? A.number : 0;
} };
(function(e) {
  e.NORMAL = "normal", e.STRICT = "strict";
})(Xt || (Xt = {}));
var Ze, gc = { name: "line-break", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  return A === "strict" ? Xt.STRICT : Xt.NORMAL;
} }, wc = { name: "line-height", initialValue: "normal", prefix: !1, type: 4 }, gs = function(e, A) {
  return P(e) && e.value === "normal" ? 1.2 * A : e.type === 17 ? A * e.number : AA(e) ? N(e, A) : A;
}, hc = { name: "list-style-image", initialValue: "none", type: 0, prefix: !1, parse: function(e, A) {
  return A.type === 20 && A.value === "none" ? null : pn(e, A);
} }, Qc = { name: "list-style-position", initialValue: "outside", prefix: !1, type: 2, parse: function(e, A) {
  return A === "inside" ? 0 : 1;
...
}, pc = lr("top"), Cc = lr("right"), fc = lr("bottom"), Uc = lr("left"), Fc = { name: "overflow", initialValue: "visible", prefix: !1, type: 1, parse: function(e, A) {
...
} }, mc = { name: "overflow-wrap", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  return A === "break-word" ? "break-word" : "normal";
} }, dr = function(e) {
  return { name: "padding-" + e, initialValue: "0", prefix: !1, type: 3, format: "length-percentage" };
}, yc = dr("top"), Ec = dr("right"), bc = dr("bottom"), Hc = dr("left"), kc = { name: "text-align", initialValue: "left", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "right":
      return 2;
    case "center":
...
} }, vc = { name: "position", initialValue: "static", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "relative":
      return 1;
    case "absolute":
...
} }, xc = { name: "text-transform", initialValue: "none", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "uppercase":
      return 2;
    case "lowercase":
  ...
  return 0;
} }, Lc = { name: "transform", initialValue: "none", prefix: !0, type: 0, parse: function(e, A) {
...
} }, ws = { type: 16, number: 50, flags: 4 }, Sc = [ws, ws], Dc = { name: "transform-origin", initialValue: "50% 50%", prefix: !0, type: 1, parse: function(e, A) {
  var t = A.filter(AA);
  return t.length !== 2 ? Sc : [t[0], t[1]];
} }, Tc = { name: "visible", initialValue: "none", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "hidden":
      return 1;
    case "collapse":
...
for (var Oc = { name: "word-break", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "break-all":
      return Ze.BREAK_ALL;
    case "keep-all":
...
} }, Mc = { name: "z-index", initialValue: "auto", prefix: !1, type: 0, parse: function(e, A) {
  if (A.type === 20)
...
}, Rc = { name: "opacity", initialValue: "1", type: 0, prefix: !1, parse: function(e, A) {
  return He(A) ? A.number : 1;
} }, Gc = { name: "text-decoration-color", initialValue: "transparent", prefix: !1, type: 3, format: "color" }, Vc = { name: "text-decoration-line", initialValue: "none", prefix: !1, type: 1, parse: function(e, A) {
  return A.filter(P).map(function(t) {
    switch (t.value) {
      case "underline":
        return 1;
...
} }, Pc = { name: "font-family", initialValue: "", prefix: !1, type: 1, parse: function(e, A) {
  var t = [], r = [];
...
} }, _c = { name: "font-size", initialValue: "0", prefix: !1, type: 3, format: "length" }, Nc = { name: "font-weight", initialValue: "normal", type: 0, prefix: !1, parse: function(e, A) {
  return He(A) ? A.number : P(A) && A.value === "bold" ? 700 : 400;
} }, Xc = { name: "font-variant", initialValue: "none", type: 1, prefix: !1, parse: function(e, A) {
  return A.filter(P).map(function(t) {
    return t.value;
  });
} }, Jc = { name: "font-style", initialValue: "normal", prefix: !1, type: 2, parse: function(e, A) {
  switch (A) {
    case "oblique":
      return "oblique";
    case "italic":
  ...
  return (e & A) != 0;
}, Wc = { name: "content", initialValue: "none", type: 1, prefix: !1, parse: function(e, A) {
  if (A.length === 0)
    return [];
  var t = A[0];
  return t.type === 20 && t.value === "none" ? [] : A;
} }, Yc = { name: "counter-increment", initialValue: "none", prefix: !0, type: 1, parse: function(e, A) {
  if (A.length === 0)
    return null;
  var t = A[0];
  ...
  return r;
} }, jc = { name: "counter-reset", initialValue: "none", prefix: !0, type: 1, parse: function(e, A) {
  if (A.length === 0)
    return [];
...
} }, qc = { name: "quotes", initialValue: "none", prefix: !0, type: 1, parse: function(e, A) {
  if (A.length === 0)
    return null;
  var t = A[0];
  if (t.type === 20 && t.value === "none")
...
} }, $c = { name: "paint-order", initialValue: "normal", prefix: !1, type: 1, parse: function(e, A) {
  var t = [];
...
} }, AB = { name: "-webkit-text-stroke-color", initialValue: "currentcolor", prefix: !1, type: 3, format: "color" }, eB = { name: "-webkit-text-stroke-width", initialValue: "0", type: 0, prefix: !1, parse: function(e, A) {
  return At(A) ? A.number : 0;
} }, tB = function() {
  function e(A, t) {
    var r, n;
    this.animationDuration = y(A, Zc, t.animationDuration), this.backgroundClip = y(A, Ta, t.backgroundClip), this.backgroundColor = y(A, Oa, t.backgroundColor), this.backgroundImage = y(A, Ra, t.backgroundImage), this.backgroundOrigin = y(A, Ga, t.backgroundOrigin), this.backgroundPosition = y(A, Va, t.backgroundPosition), this.backgroundRepeat = y(A, Pa, t.backgroundRepeat), this.backgroundSize = y(A, Na, t.backgroundSize), this.borderTopColor = y(A, Ja, t.borderTopColor), this.borderRightColor = y(A, Wa, t.borderRightColor), this.borderBottomColor = y(A, Ya, t.borderBottomColor), this.borderLeftColor = y(A, ja, t.borderLeftColor), this.borderTopLeftRadius = y(A, Za, t.borderTopLeftRadius), this.borderTopRightRadius = y(A, qa, t.borderTopRightRadius), this.borderBottomRightRadius = y(A, za, t.borderBottomRightRadius), this.borderBottomLeftRadius = y(A, $a, t.borderBottomLeftRadius), this.borderTopStyle = y(A, Ac, t.borderTopStyle), this.borderRightStyle = y(A, ec, t.borderRightStyle), this.borderBottomStyle = y(A, tc, t.borderBottomStyle), this.borderLeftStyle = y(A, rc, t.borderLeftStyle), this.borderTopWidth = y(A, nc, t.borderTopWidth), this.borderRightWidth = y(A, sc, t.borderRightWidth), this.borderBottomWidth = y(A, oc, t.borderBottomWidth), this.borderLeftWidth = y(A, ic, t.borderLeftWidth), this.boxShadow = y(A, zc, t.boxShadow), this.color = y(A, ac, t.color), this.direction = y(A, cc, t.direction), this.display = y(A, Bc, t.display), this.float = y(A, dc, t.cssFloat), this.fontFamily = y(A, Pc, t.fontFamily), this.fontSize = y(A, _c, t.fontSize), this.fontStyle = y(A, Jc, t.fontStyle), this.fontVariant = y(A, Xc, t.fontVariant), this.fontWeight = y(A, Nc, t.fontWeight), this.letterSpacing = y(A, uc, t.letterSpacing), this.lineBreak = y(A, gc, t.lineBreak), this.lineHeight = y(A, wc, t.lineHeight), this.listStyleImage = y(A, hc, t.listStyleImage), this.listStylePosition = y(A, Qc, t.listStylePosition), this.listStyleType = y(A, Jr, t.listStyleType), this.marginTop = y(A, pc, t.marginTop), this.marginRight = y(A, Cc, t.marginRight), this.marginBottom = y(A, fc, t.marginBottom), this.marginLeft = y(A, Uc, t.marginLeft), this.opacity = y(A, Rc, t.opacity);
    var s = y(A, Fc, t.overflow);
    this.overflowX = s[0], this.overflowY = s[s.length > 1 ? 1 : 0], this.overflowWrap = y(A, mc, t.overflowWrap), this.paddingTop = y(A, yc, t.paddingTop), this.paddingRight = y(A, Ec, t.paddingRight), this.paddingBottom = y(A, bc, t.paddingBottom), this.paddingLeft = y(A, Hc, t.paddingLeft), this.paintOrder = y(A, $c, t.paintOrder), this.position = y(A, vc, t.position), this.textAlign = y(A, kc, t.textAlign), this.textDecorationColor = y(A, Gc, (r = t.textDecorationColor) !== null && r !== void 0 ? r : t.color), this.textDecorationLine = y(A, Vc, (n = t.textDecorationLine) !== null && n !== void 0 ? n : t.textDecoration), this.textShadow = y(A, Ic, t.textShadow), this.textTransform = y(A, xc, t.textTransform), this.transform = y(A, Lc, t.transform), this.transformOrigin = y(A, Dc, t.transformOrigin), this.visibility = y(A, Tc, t.visibility), this.webkitTextStrokeColor = y(A, AB, t.webkitTextStrokeColor), this.webkitTextStrokeWidth = y(A, eB, t.webkitTextStrokeWidth), this.wordBreak = y(A, Oc, t.wordBreak), this.zIndex = y(A, Mc, t.zIndex);
  }
  ...
  this.content = y(e, Wc, A.content), this.quotes = y(e, qc, A.quotes);
}, ps = function(e, A) {
  this.counterIncrement = y(e, Yc, A.counterIncrement), this.counterReset = y(e, jc, A.counterReset);
}, y = function(e, A, t) {
  ...
  this.context = e, this.textNodes = [], this.elements = [], this.flags = 0, Wr(A, 3), this.styles = new tB(e, window.getComputedStyle(A, null)), Zr(A) && (this.styles.animationDuration.some(function(t) {
    return t > 0;
...
}, nB = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", Je = typeof Uint8Array > "u" ? [] : new Uint8Array(256), Ft = 0; Ft < 64; Ft++)
  Je[nB.charCodeAt(Ft)] = Ft;
...
}(), oB = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", iB = typeof Uint8Array > "u" ? [] : new Uint8Array(256), mt = 0; mt < 64; mt++)
  iB[oB.charCodeAt(mt)] = mt;
var qe, fs = 8, Er = 9, Us = 11, Fs = 12, aB = function() {
  for (var e = [], A = 0; A < arguments.length; A++)
    e[A] = arguments[A];
  if (String.fromCodePoint)
    return String.fromCodePoint.apply(String, e);
  ...
  var t, r, n, s = function(a) {
    ...
    var H = typeof ArrayBuffer < "u" && typeof Uint8Array < "u" && Uint8Array.prototype.slice !== void 0 ? new ArrayBuffer(h) : new Array(h), F = Array.isArray(H) ? H : new Uint8Array(H);
    for (l = 0; l < p; l += 4)
      d = Je[a.charCodeAt(l)], g = Je[a.charCodeAt(l + 1)], u = Je[a.charCodeAt(l + 2)], w = Je[a.charCodeAt(l + 3)], F[U++] = d << 2 | g >> 4, F[U++] = (15 & g) << 4 | u >> 2, F[U++] = (3 & u) << 6 | 63 & w;
    return H;
  }(e), o = Array.isArray(s) ? function(a) {
    for (var l = a.length, d = [], g = 0; g < l; g += 4)
      d.push(a[g + 3] << 24 | a[g + 2] << 16 | a[g + 1] << 8 | a[g]);
  ...
  return new sB(o[0], o[1], o[2], o[3], c, B);
  ...
  return { next: function() {
    ...
    for (var o = KA; r < t && (o = lB(0, s, ++r)) === KA; )
      ;
    if (o !== KA || r === t) {
      var i = aB.apply(null, A.slice(n, r));
  ...
  return function(t) {
    for (var r, n = dB(t), s = []; !(r = n.next()).done; )
...
}, wB = [32, 160, 4961, 65792, 65793, 4153, 4241], hB = function(e, A) {
  for (var t, r = function(o, i) {
    var c = Pt(o), B = Ba(c, i), a = B[0], l = B[1], d = B[2], g = c.length, u = 0, w = 0;
    return { next: function() {
      if (w >= g)
        return { done: !0, value: null };
      for (var h = x; w < g && (h = ca(c, l, a, ++w, d)) === x; )
        ;
      if (h !== x || w === g) {
        var p = new la(c, h, u, w);
    ...
    if (t.value) {
      ...
      i.forEach(function(B) {
        wB.indexOf(B) === -1 ? c += z(B) : (c.length && n.push(c), n.push(z(B)), c = "");
      }), c.length && n.push(c);
    }
  }; !(t = r.next()).done; )
    s();
  ...
  this.text = pB(A.data, t.textTransform), this.textBounds = function(r, n, s, o) {
    var i = gB(n, s), c = [], B = 0;
  ...
  switch (A) {
    ...
    case 3:
      return e.replace(CB, fB);
    case 2:
      return e.toUpperCase();
    default:
      return e;
  }
}, CB = /(^|\s|:|-|\(|\))([a-z])/g, fB = function(e, A, t) {
  ...
  for (var n = A.firstChild, s = void 0; n; n = s)
    if (s = n.nextSibling, Do(n) && n.data.trim().length > 0)
      ...
      if (Ro(n) && n.assignedNodes)
        ...
        var o = Ko(e, n);
        o.styles.isVisible() && (EB(n, o, r) ? o.flags |= 4 : bB(o.styles) && (o.flags |= 2), yB.indexOf(n.tagName) !== -1 && (o.flags |= 8), t.elements.push(o), n.slot, n.shadowRoot ? St(e, n.shadowRoot, o, r) : Yt(n) || To(n) || jt(n) || St(e, n, o, r));
      }
}, Ko = function(e, A) {
  return qr(A) ? new bo(e, A) : Oo(A) ? new Ho(e, A) : To(A) ? new ko(e, A) : HB(A) ? new vo(e, A) : kB(A) ? new jr(e, A) : vB(A) ? new fn(e, A) : jt(A) ? new Io(e, A) : Yt(A) ? new xo(e, A) : Mo(A) ? new Lo(e, A) : new ZA(e, A);
}, So = function(e, A) {
  var t = Ko(e, A);
  ...
  switch (A) {
    ...
    case 20:
      return Fe(e, 1, 19999, LB, 3, r);
    case 21:
      return q(e, 2790, 2799, !0, r);
    case 22:
      return q(e, 2662, 2671, !0, r);
    case 22:
      return Fe(e, 1, 10999, xB, 3, r);
    case 23:
  ...
  return e.prototype.toIFrame = function(A, t) {
    ...
    var s = A.defaultView.pageXOffset, o = A.defaultView.pageYOffset, i = n.contentWindow, c = i.document, B = TB(n).then(function() {
      return fA(r, void 0, void 0, function() {
        var a, l;
        return QA(this, function(d) {
          switch (d.label) {
            case 0:
              return this.scrolledElements.forEach(GB), i && (i.scrollTo(t.left, t.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || i.scrollY === t.top && i.scrollX === t.left || (this.context.logger.warn("Unable to restore scroll position for cloned document"), this.context.windowBounds = this.context.windowBounds.add(i.scrollX - t.left, i.scrollY - t.top, 0, 0))), a = this.options.onclone, (l = this.clonedReferenceElement) === void 0 ? [2, Promise.reject("Error finding the " + this.referenceElement.nodeName + " in the cloned document")] : c.fonts && c.fonts.ready ? [4, c.fonts.ready] : [3, 2];
            case 1:
              d.sent(), d.label = 2;
            case 2:
              return /(AppleWebKit)/g.test(navigator.userAgent) ? [4, DB(c)] : [3, 4];
            case 3:
              d.sent(), d.label = 4;
            case 4:
    ...
    return c.open(), c.write(MB(document.doctype) + "<html></html>"), RB(this.referenceElement.ownerDocument, s, o), c.replaceChild(c.adoptNode(this.documentElement), c.documentElement), c.close(), B;
    ...
    ve(t) && (t.tagName === "SCRIPT" || t.hasAttribute(Vo) || typeof this.options.ignoreElements == "function" && this.options.ignoreElements(t)) || this.options.copyStyles && ve(t) && ks(t) || A.appendChild(this.cloneNode(t, r));
  }, e.prototype.cloneChildNodes = function(A, t, r) {
    for (var n = this, s = A.shadowRoot ? A.shadowRoot.firstChild : A.firstChild; s; s = s.nextSibling)
      if (ve(s) && Ro(s) && typeof s.assignedNodes == "function") {
    ...
    if (r && ve(A) && (Zr(A) || Dt(A))) {
      ...
      this.referenceElement === A && Zr(n) && (this.clonedReferenceElement = n), Un(n) && VB(n);
      ...
      return a && n.appendChild(a), this.counters.pop(c), (s && (this.options.copyStyles || Dt(A)) && !Mo(A) || t) && Hr(s, n), A.scrollTop === 0 && A.scrollLeft === 0 || this.scrolledElements.push([n, A.scrollLeft, A.scrollTop]), (Yt(A) || jt(A)) && (Yt(n) || jt(n)) && (n.value = A.value), n;
    }
    return A.cloneNode(!1);
    ...
    if (r) {
      ...
      if (i && o && o !== "none" && o !== "-moz-alt-content" && r.display !== "none") {
        ...
        var c = new rB(this.context, r), B = i.createElement("html2canvaspseudoelement");
        Hr(r, B), c.content.forEach(function(l) {
          if (l.type === 0)
            ...
            if (l.name === "attr") {
              ...
              if (w && P(w)) {
                var p = s.counters.getCounterValue(w.value), U = h && P(h) ? Jr.parse(s.context, h.value) : 3;
                B.appendChild(i.createTextNode(et(p, U, !1)));
              }
            } else if (l.name === "counters") {
              var H = l.values.filter(De), F = (w = H[0], H[1]);
              if (h = H[2], w && P(w)) {
                var C = s.counters.getCounterValues(w.value), b = h && P(h) ? Jr.parse(s.context, h.value) : 3, v = F && F.type === 0 ? F.value : "", E = C.map(function(_) {
                  return et(_, b, !1);
                }).join(v);
...
var G, KB = function(e, A) {
  ...
  return Promise.all([].slice.call(e.images, 0).map(SB));
}, TB = function(e) {
  return new Promise(function(A, t) {
...
}, OB = ["all", "d", "content"], Hr = function(e, A) {
  for (var t = e.length - 1; t >= 0; t--) {
    var r = e.item(t);
    OB.indexOf(r) === -1 && A.style.setProperty(r, e.getPropertyValue(r));
  }
  return A;
}, MB = function(e) {
  var A = "";
  ...
  return e.prototype.addImage = function(A) {
    ...
    return this.has(A) || (vr(A) || WB(A)) && (this._cache[A] = this.loadImage(A)).catch(function() {
    }), t;
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(i) {
        switch (i.label) {
          case 0:
            return t = Po.isSameOrigin(A), r = !kr(A) && this._options.useCORS === !0 && lA.SUPPORT_CORS_IMAGES && !t, n = !kr(A) && !t && !vr(A) && typeof this._options.proxy == "string" && lA.SUPPORT_CORS_XHR && !r, t || this._options.allowTaint !== !1 || kr(A) || vr(A) || n || r ? (s = A, n ? [4, this.proxy(s)] : [3, 2]) : [2];
          case 1:
            s = i.sent(), i.label = 2;
          case 2:
            return this.context.logger.debug("Added image " + A.substring(0, 256)), [4, new Promise(function(c, B) {
              ...
              a.onload = function() {
                return c(a);
              }, a.onerror = B, (YB(s) || r) && (a.crossOrigin = "anonymous"), a.src = s, a.complete === !0 && setTimeout(function() {
                return c(a);
...
}(), NB = /^data:image\/svg\+xml/i, XB = /^data:image\/.*;base64,/i, JB = /^data:image\/.*/i, WB = function(e) {
  ...
  var p = t.width - i, U = t.height - l, H = t.width - a, F = t.height - u, C = A.borderTopWidth, b = A.borderRightWidth, v = A.borderBottomWidth, E = A.borderLeftWidth, _ = N(A.paddingTop, e.bounds.width), eA = N(A.paddingRight, e.bounds.width), gA = N(A.paddingBottom, e.bounds.width), Y = N(A.paddingLeft, e.bounds.width);
  this.topLeftBorderDoubleOuterBox = n > 0 || s > 0 ? J(t.left + E / 3, t.top + C / 3, n - E / 3, s - C / 3, G.TOP_LEFT) : new m(t.left + E / 3, t.top + C / 3), this.topRightBorderDoubleOuterBox = n > 0 || s > 0 ? J(t.left + p, t.top + C / 3, i - b / 3, c - C / 3, G.TOP_RIGHT) : new m(t.left + t.width - b / 3, t.top + C / 3), this.bottomRightBorderDoubleOuterBox = a > 0 || l > 0 ? J(t.left + H, t.top + U, a - b / 3, l - v / 3, G.BOTTOM_RIGHT) : new m(t.left + t.width - b / 3, t.top + t.height - v / 3), this.bottomLeftBorderDoubleOuterBox = g > 0 || u > 0 ? J(t.left + E / 3, t.top + F, g - E / 3, u - v / 3, G.BOTTOM_LEFT) : new m(t.left + E / 3, t.top + t.height - v / 3), this.topLeftBorderDoubleInnerBox = n > 0 || s > 0 ? J(t.left + 2 * E / 3, t.top + 2 * C / 3, n - 2 * E / 3, s - 2 * C / 3, G.TOP_LEFT) : new m(t.left + 2 * E / 3, t.top + 2 * C / 3), this.topRightBorderDoubleInnerBox = n > 0 || s > 0 ? J(t.left + p, t.top + 2 * C / 3, i - 2 * b / 3, c - 2 * C / 3, G.TOP_RIGHT) : new m(t.left + t.width - 2 * b / 3, t.top + 2 * C / 3), this.bottomRightBorderDoubleInnerBox = a > 0 || l > 0 ? J(t.left + H, t.top + U, a - 2 * b / 3, l - 2 * v / 3, G.BOTTOM_RIGHT) : new m(t.left + t.width - 2 * b / 3, t.top + t.height - 2 * v / 3), this.bottomLeftBorderDoubleInnerBox = g > 0 || u > 0 ? J(t.left + 2 * E / 3, t.top + F, g - 2 * E / 3, u - 2 * v / 3, G.BOTTOM_LEFT) : new m(t.left + 2 * E / 3, t.top + t.height - 2 * v / 3), this.topLeftBorderStroke = n > 0 || s > 0 ? J(t.left + E / 2, t.top + C / 2, n - E / 2, s - C / 2, G.TOP_LEFT) : new m(t.left + E / 2, t.top + C / 2), this.topRightBorderStroke = n > 0 || s > 0 ? J(t.left + p, t.top + C / 2, i - b / 2, c - C / 2, G.TOP_RIGHT) : new m(t.left + t.width - b / 2, t.top + C / 2), this.bottomRightBorderStroke = a > 0 || l > 0 ? J(t.left + H, t.top + U, a - b / 2, l - v / 2, G.BOTTOM_RIGHT) : new m(t.left + t.width - b / 2, t.top + t.height - v / 2), this.bottomLeftBorderStroke = g > 0 || u > 0 ? J(t.left + E / 2, t.top + F, g - E / 2, u - v / 2, G.BOTTOM_LEFT) : new m(t.left + E / 2, t.top + t.height - v / 2), this.topLeftBorderBox = n > 0 || s > 0 ? J(t.left, t.top, n, s, G.TOP_LEFT) : new m(t.left, t.top), this.topRightBorderBox = i > 0 || c > 0 ? J(t.left + p, t.top, i, c, G.TOP_RIGHT) : new m(t.left + t.width, t.top), this.bottomRightBorderBox = a > 0 || l > 0 ? J(t.left + H, t.top + U, a, l, G.BOTTOM_RIGHT) : new m(t.left + t.width, t.top + t.height), this.bottomLeftBorderBox = g > 0 || u > 0 ? J(t.left, t.top + F, g, u, G.BOTTOM_LEFT) : new m(t.left, t.top + t.height), this.topLeftPaddingBox = n > 0 || s > 0 ? J(t.left + E, t.top + C, Math.max(0, n - E), Math.max(0, s - C), G.TOP_LEFT) : new m(t.left + E, t.top + C), this.topRightPaddingBox = i > 0 || c > 0 ? J(t.left + Math.min(p, t.width - b), t.top + C, p > t.width + b ? 0 : Math.max(0, i - b), Math.max(0, c - C), G.TOP_RIGHT) : new m(t.left + t.width - b, t.top + C), this.bottomRightPaddingBox = a > 0 || l > 0 ? J(t.left + Math.min(H, t.width - E), t.top + Math.min(U, t.height - v), Math.max(0, a - b), Math.max(0, l - v), G.BOTTOM_RIGHT) : new m(t.left + t.width - b, t.top + t.height - v), this.bottomLeftPaddingBox = g > 0 || u > 0 ? J(t.left + E, t.top + Math.min(F, t.height - v), Math.max(0, g - E), Math.max(0, u - v), G.BOTTOM_LEFT) : new m(t.left + E, t.top + t.height - v), this.topLeftContentBox = n > 0 || s > 0 ? J(t.left + E + Y, t.top + C + _, Math.max(0, n - (E + Y)), Math.max(0, s - (C + _)), G.TOP_LEFT) : new m(t.left + E + Y, t.top + C + _), this.topRightContentBox = i > 0 || c > 0 ? J(t.left + Math.min(p, t.width + E + Y), t.top + C + _, p > t.width + E + Y ? 0 : i - E + Y, c - (C + _), G.TOP_RIGHT) : new m(t.left + t.width - (b + eA), t.top + C + _), this.bottomRightContentBox = a > 0 || l > 0 ? J(t.left + Math.min(H, t.width - (E + Y)), t.top + Math.min(U, t.height + C + _), Math.max(0, a - (b + eA)), l - (v + gA), G.BOTTOM_RIGHT) : new m(t.left + t.width - (b + eA), t.top + t.height - (v + gA)), this.bottomLeftContentBox = g > 0 || u > 0 ? J(t.left + E + Y, t.top + F, Math.max(0, g - (E + Y)), u - (v + gA), G.BOTTOM_LEFT) : new m(t.left + E + Y, t.top + t.height - (v + gA));
};
(function(e) {
...
var J = function(e, A, t, r, n) {
  ...
  function e(A, t) {
    if (this.container = A, this.parent = t, this.effects = [], this.curves = new ZB(this.container), this.container.styles.opacity < 1 && this.effects.push(new zB(this.container.styles.opacity)), this.container.styles.transform !== null) {
      ...
      this.effects.push(new qB(r, n, s));
    }
  ...
  for (var t = e instanceof jr ? e.start : 1, r = e instanceof jr && e.reversed, n = 0; n < A.length; n++) {
    var s = A[n];
    s.container instanceof vo && typeof s.container.value == "number" && s.container.value !== 0 && (t = s.container.value), s.listValue = et(t, s.container.styles.listStyleType, !0), t += r ? -1 : 1;
  }
}, Ms = function(e, A) {
  switch (A) {
    case 0:
  ...
  var r = function(B, a) {
    ...
    return B === 0 ? a.bounds : B === 2 ? zt(a) : Rs(a);
  }(ke(e.styles.backgroundClip, A), e), s = $B(ke(e.styles.backgroundSize, A), t, r), o = s[0], i = s[1], c = Xe(ke(e.styles.backgroundPosition, A), r.width - o, r.height - i);
  return [Al(ke(e.styles.backgroundRepeat, A), c, s, r, n), Math.round(r.left + c[0]), Math.round(r.top + c[1]), o, i];
}, ye = function(e) {
  ...
  function A(t, r) {
    var n = e.call(this, t, r) || this;
    return n._activeEffects = [], n.canvas = r.canvas ? r.canvas : document.createElement("canvas"), n.ctx = n.canvas.getContext("2d"), r.canvas || (n.canvas.width = Math.floor(r.width * r.scale), n.canvas.height = Math.floor(r.height * r.scale), n.canvas.style.width = r.width + "px", n.canvas.style.height = r.height + "px"), n.fontMetrics = new el(document), n.ctx.scale(n.options.scale, n.options.scale), n.ctx.translate(-r.x, -r.y), n.ctx.textBaseline = "bottom", n._activeEffects = [], n.context.logger.debug("Canvas renderer initialized (" + r.width + "x" + r.height + ") with scale " + r.scale), n;
  }
  return GA(A, e), A.prototype.applyEffects = function(t) {
    ...
    }).join(""), n = il(t.fontFamily).join(", "), s = At(t.fontSize) ? "" + t.fontSize.number + t.fontSize.unit : t.fontSize.number + "px";
    ...
    return fA(this, void 0, void 0, function() {
      var r, n, s, o, i, c, B, a, l, d, g, u, w, h, p, U, H, F;
        ...
        switch (C.label) {
          ...
          case 14:
            if (r instanceof fn && (a = Math.min(r.bounds.width, r.bounds.height), r.type === Jt ? r.checked && (this.ctx.save(), this.path([new m(r.bounds.left + 0.39363 * a, r.bounds.top + 0.79 * a), new m(r.bounds.left + 0.16 * a, r.bounds.top + 0.5549 * a), new m(r.bounds.left + 0.27347 * a, r.bounds.top + 0.44071 * a), new m(r.bounds.left + 0.39694 * a, r.bounds.top + 0.5649 * a), new m(r.bounds.left + 0.72983 * a, r.bounds.top + 0.23 * a), new m(r.bounds.left + 0.84 * a, r.bounds.top + 0.34085 * a), new m(r.bounds.left + 0.39363 * a, r.bounds.top + 0.79 * a)]), this.ctx.fillStyle = oA(bs), this.ctx.fill(), this.ctx.restore()) : r.type === Wt && r.checked && (this.ctx.save(), this.ctx.beginPath(), this.ctx.arc(r.bounds.left + a / 2, r.bounds.top + a / 2, a / 4, 0, 2 * Math.PI, !0), this.ctx.fillStyle = oA(bs), this.ctx.fill(), this.ctx.restore())), rl(r) && r.value.length) {
              ...
              w = F.add(u, 0, 0, -F.height / 2 + 1), this.ctx.save(), this.path([new m(F.left, F.top), new m(F.left + F.width, F.top), new m(F.left + F.width, F.top + F.height), new m(F.left, F.top + F.height)]), this.ctx.clip(), this.renderTextWithLetterSpacing(new ze(r.value, w), s.letterSpacing, g), this.ctx.restore(), this.ctx.textBaseline = "alphabetic", this.ctx.textAlign = "left";
            }
            ...
            if ((h = r.styles.listStyleImage).type !== 0)
              return [3, 18];
            p = void 0, U = h.url, C.label = 15;
          case 15:
            return C.trys.push([15, 17, , 18]), [4, this.context.cache.match(U)];
          case 16:
            return p = C.sent(), this.ctx.drawImage(p, r.bounds.left - (p.width + 10), r.bounds.top), [3, 18];
          case 17:
            return C.sent(), this.context.logger.error("Error loading list-style-image " + U), [3, 18];
          case 18:
            return [3, 20];
          case 19:
            t.listValue && r.styles.listStyleType !== -1 && (H = this.createFontStyle(s)[0], this.ctx.font = H, this.ctx.fillStyle = oA(s.color), this.ctx.textBaseline = "middle", this.ctx.textAlign = "right", F = new ne(r.bounds.left, r.bounds.top + N(r.styles.paddingTop, r.bounds.width), r.bounds.width, gs(s.lineHeight, s.fontSize.number) / 2 + 1), this.renderTextWithLetterSpacing(new ze(t.listValue, F), s.letterSpacing, gs(s.lineHeight, s.fontSize.number) / 2 + 2), this.ctx.textBaseline = "bottom", this.ctx.textAlign = "left"), C.label = 20;
          case 20:
            return [2];
        }
      });
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(U) {
        switch (U.label) {
          ...
          case 6:
            U.sent(), s = 0, o = t.nonInlineLevel, U.label = 7;
          case 7:
          ...
          case 9:
            return s++, [3, 7];
          case 10:
            i = 0, c = t.nonPositionedFloats, U.label = 11;
          case 11:
          ...
          case 13:
            return i++, [3, 11];
          case 14:
            B = 0, a = t.nonPositionedInlineLevel, U.label = 15;
          case 15:
          ...
          case 17:
            return B++, [3, 15];
          case 18:
            l = 0, d = t.inlineLevel, U.label = 19;
          case 19:
          ...
          case 21:
            return l++, [3, 19];
          case 22:
            g = 0, u = t.zeroOrAutoZIndexOrTransformedOrOpacity, U.label = 23;
          case 23:
        ...
        switch (B.label) {
          case 0:
            r = t.styles.backgroundImage.length - 1, n = function(a) {
              var l, d, g, u, w, h, p, U, H, F, C, b, v, E, _, eA, gA, Y, tA, sA, bA, aA, pA, vA, FA, IA, VA, PA, xA, HA, qA;
              return QA(this, function($) {
                switch ($.label) {
                  ...
                  case 5:
                    a.type === 1 ? (u = Ir(t, r, [null, null, null]), eA = u[0], aA = u[1], pA = u[2], tA = u[3], sA = u[4], w = Ma(a.angle, tA, sA), h = w[0], p = w[1], U = w[2], H = w[3], F = w[4], (C = document.createElement("canvas")).width = tA, C.height = sA, b = C.getContext("2d"), v = b.createLinearGradient(p, H, U, F), ds(a.stops, h).forEach(function(S) {
                      return v.addColorStop(S.stop, oA(S.color));
                    }), b.fillStyle = v, b.fillRect(0, 0, tA, sA), tA > 0 && sA > 0 && (E = s.ctx.createPattern(C, "repeat"), s.renderRepeat(eA, E, aA, pA))) : function(S) {
                      return S.type === 2;
                    }(a) && (_ = Ir(t, r, [null, null, null]), eA = _[0], gA = _[1], Y = _[2], tA = _[3], sA = _[4], bA = a.position.length === 0 ? [Qn] : a.position, aA = N(bA[0], tA), pA = N(bA[bA.length - 1], sA), vA = function(S, D, M, wA, hA) {
                      var j = 0, cA = 0;
                      switch (S.size) {
                        case 0:
                    ...
                    }(a, aA, pA, tA, sA), FA = vA[0], IA = vA[1], FA > 0 && IA > 0 && (VA = s.ctx.createRadialGradient(gA + aA, Y + pA, 0, gA + aA, Y + pA, FA), ds(a.stops, 2 * FA).forEach(function(S) {
                      return VA.addColorStop(S.stop, oA(S.color));
                    }), s.path(eA), s.ctx.fillStyle = VA, FA !== IA ? (PA = t.bounds.left + 0.5 * t.bounds.width, xA = t.bounds.top + 0.5 * t.bounds.height, qA = 1 / (HA = IA / FA), s.ctx.save(), s.ctx.translate(PA, xA), s.ctx.transform(1, 0, 0, HA, 0, 0), s.ctx.translate(-PA, -xA), s.ctx.fillRect(gA, qA * (Y - xA) + xA, tA, sA * qA), s.ctx.restore()) : s.ctx.fill())), $.label = 6;
                  case 6:
                    return r--, [2];
                }
              });
    ...
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(d) {
        switch (d.label) {
          case 0:
            return this.applyEffects(t.getEffects(2)), r = t.container.styles, n = !le(r.backgroundColor) || r.backgroundImage.length, s = [{ style: r.borderTopStyle, color: r.borderTopColor, width: r.borderTopWidth }, { style: r.borderRightStyle, color: r.borderRightColor, width: r.borderRightWidth }, { style: r.borderBottomStyle, color: r.borderBottomColor, width: r.borderBottomWidth }, { style: r.borderLeftStyle, color: r.borderLeftColor, width: r.borderLeftWidth }], o = nl(ke(r.backgroundClip, 0), t.curves), n || r.boxShadow.length ? (this.ctx.save(), this.path(o), this.ctx.clip(), le(r.backgroundColor) || (this.ctx.fillStyle = oA(r.backgroundColor), this.ctx.fill()), [4, this.renderBackgroundImage(t.container)]) : [3, 2];
          case 1:
            d.sent(), this.ctx.restore(), r.boxShadow.slice(0).reverse().forEach(function(g) {
              l.ctx.save();
              var u, w, h, p, U, H = Zt(t.curves), F = g.inset ? 0 : 1e4, C = (u = H, w = -F + (g.inset ? 1 : -1) * g.spread.number, h = (g.inset ? 1 : -1) * g.spread.number, p = g.spread.number * (g.inset ? -2 : 2), U = g.spread.number * (g.inset ? -2 : 2), u.map(function(b, v) {
                switch (v) {
                  case 0:
                    return b.add(w, h);
                  case 1:
                    return b.add(w + p, h);
                  case 2:
                    return b.add(w + p, h + U);
                  case 3:
                    return b.add(w, h + U);
                }
                return b;
              }));
              g.inset ? (l.path(H), l.ctx.clip(), l.mask(C)) : (l.mask(H), l.ctx.clip(), l.path(C)), l.ctx.shadowOffsetX = g.offsetX.number + F, l.ctx.shadowOffsetY = g.offsetY.number, l.ctx.shadowColor = oA(g.color), l.ctx.shadowBlur = g.blur.number, l.ctx.fillStyle = g.inset ? oA(g.color) : "rgba(0,0,0,1)", l.ctx.fill(), l.ctx.restore();
            }), d.label = 2;
          case 2:
    ...
    return fA(this, void 0, void 0, function() {
      var i, c, B, a, l, d, g, u, w, h, p, U, H, F, C, b;
      return QA(this, function(v) {
        ...
        }(s, n), c = Ms(s, n), o === 2 && (this.path(c), this.ctx.clip()), DA(c[0]) ? (B = c[0].start.x, a = c[0].start.y) : (B = c[0].x, a = c[0].y), DA(c[1]) ? (l = c[1].end.x, d = c[1].end.y) : (l = c[1].x, d = c[1].y), g = Math.abs(n === 0 || n === 2 ? B - l : a - d), this.ctx.beginPath(), o === 3 ? this.formatPath(i) : this.formatPath(c.slice(0, 2)), u = r < 3 ? 3 * r : 2 * r, w = r < 3 ? 2 * r : r, o === 3 && (u = r, w = r), h = !0, g <= 2 * u ? h = !1 : g <= 2 * u + w ? (u *= p = g / (2 * u + w), w *= p) : (U = Math.floor((g + w) / (u + w)), H = (g - U * u) / (U - 1), w = (F = (g - (U + 1) * u) / U) <= 0 || Math.abs(w - H) < Math.abs(w - F) ? H : F), h && (o === 3 ? this.ctx.setLineDash([0, u + w]) : this.ctx.setLineDash([u, w])), o === 3 ? (this.ctx.lineCap = "round", this.ctx.lineWidth = r) : this.ctx.lineWidth = 2 * r + 1.1, this.ctx.strokeStyle = oA(t), this.ctx.stroke(), this.ctx.setLineDash([]), o === 2 && (DA(c[0]) && (C = c[3], b = c[0], this.ctx.beginPath(), this.formatPath([new m(C.end.x, C.end.y), new m(b.start.x, b.start.y)]), this.ctx.stroke()), DA(c[1]) && (C = c[1], b = c[2], this.ctx.beginPath(), this.formatPath([new m(C.end.x, C.end.y), new m(b.start.x, b.start.y)]), this.ctx.stroke())), this.ctx.restore(), [2];
      });
    });
  ...
  return e instanceof xo || e instanceof Io || e instanceof fn && e.type !== Wt && e.type !== Jt;
}, nl = function(e, A) {
  switch (e) {
    case 0:
      return Zt(A);
...
}, ol = ["-apple-system", "system-ui"], il = function(e) {
  ...
  return GA(A, e), A.prototype.render = function(t) {
    return fA(this, void 0, void 0, function() {
      ...
      return QA(this, function(s) {
        switch (s.label) {
          case 0:
            return r = Yr(this.options.width * this.options.scale, this.options.height * this.options.scale, this.options.scale, this.options.scale, t), [4, cl(r)];
          case 1:
  ...
  function e(A, t) {
    var r;
    this.windowBounds = t, this.instanceName = "#" + e.instanceCount++, this.logger = new Bl({ id: this.instanceName, enabled: A.logging }), this.cache = (r = A.cache) !== null && r !== void 0 ? r : new _B(this, A);
  }
...
var dl = function(e, A) {
  return fA(void 0, void 0, void 0, function() {
    var t, r, n, s, o, i, c, B, a, l, d, g, u, w, h, p, U, H, F, C, b, v, E, _, eA, gA, Y, tA, sA, bA, aA, pA, vA, FA, IA, VA, PA, xA;
    return QA(this, function(HA) {
      switch (HA.label) {
        ...
        case 1:
          ...
          }(d.ownerDocument) : sr(c, d), w = u.width, h = u.height, p = u.left, U = u.top, H = ul(c, d, A.backgroundColor), F = { canvas: A.canvas, backgroundColor: H, scale: (vA = (pA = A.scale) !== null && pA !== void 0 ? pA : r.devicePixelRatio) !== null && vA !== void 0 ? vA : 1, x: ((FA = A.x) !== null && FA !== void 0 ? FA : 0) + p, y: ((IA = A.y) !== null && IA !== void 0 ? IA : 0) + U, width: (VA = A.width) !== null && VA !== void 0 ? VA : Math.ceil(w), height: (PA = A.height) !== null && PA !== void 0 ? PA : Math.ceil(h) }, B ? (c.logger.debug("Document cloned, using foreign object rendering"), [4, new al(c, F).render(d)]) : [3, 3];
        case 2:
          return C = HA.sent(), [3, 5];
        case 3:
          return c.logger.debug("Document cloned, element located at " + p + "," + U + " with size " + w + "x" + h + " using computed rendering"), c.logger.debug("Starting DOM parsing"), b = So(c, d), H === b.styles.backgroundColor && (b.styles.backgroundColor = re.TRANSPARENT), c.logger.debug("Starting renderer for element at " + F.x + "," + F.y + " with size " + F.width + "x" + F.height), [4, new tl(c, F).render(b)];
        case 4:
...
class Fn {
  constructor() {
    f(this, "captureScreenshot", async () => {
      try {
        const r = window.innerWidth, n = window.innerHeight, s = window.scrollX, o = window.scrollY, i = await (A = document.body, t = { x: s, y: o, width: r, height: n, scrollX: 0, scrollY: 0, allowTaint: !0, useCORS: !0, backgroundColor: "#000000" }, t === void 0 && (t = {}), dl(A, t));
    ...
    f(this, "getBlobFromCanvas", (A) => new Promise((t) => {
      A.toBlob((r) => {
        t(r);
      });
    }));
...
const tt = (e) => {
  ...
  n.src = e, n.setAttribute("draggable", "false");
  const s = document.createElement("button");
  s.classList.add("shake-sdk-bubble"), s.style.backgroundColor = A, s.style.boxShadow = `0 2px 2px ${t}`, s.appendChild(n);
  const o = document.createElement("div"), i = o.attachShadow({ mode: "open" });
  return ue(i), i.appendChild(s), gl(s, r), o;
}, gl = (e, A) => {
  let t = !1, r = 0, n = 0, s = !1;
...
const jo = (e) => e === uA.IMAGE ? `screenshot_${en((/* @__PURE__ */ new Date()).toString())}.jpg` : e === uA.VIDEO ? `screen_recording_${en((/* @__PURE__ */ new Date()).toString())}.mp4` : "";
async function Zo(e) {
  await qo(e, uA.IMAGE);
}
async function qo(e, A) {
  if (!e)
    return;
  const t = { type: A, data: e, name: jo(A), timestamp: (/* @__PURE__ */ new Date()).getTime() };
  await no(t);
}
const zo = async () => {
  W("Returning to Shake.");
  const e = iA.localStorage.getShakeState(), A = await rr(), t = ci(e, A);
  document.body.appendChild(t), iA.localStorage.setShakeOpened(!0);
}, rt = (e = !0) => {
  W("Shake closed");
  const A = iA.localStorage;
  e && (Vl(), A.setShakeState(null), new Promise((r, n) => {
    const s = indexedDB.open(st, 1);
    s.onerror = function() {
      n("Error opening database");
    }, s.onsuccess = function(o) {
...
const wl = async (e) => {
  ...
  try {
    ...
    A.onStartListener = () => {
      document.body.appendChild(e), rt(!1);
    }, A.onStopListener = (t) => {
      e.remove(), wl(t);
    }, await A.start();
  } catch (e) {
...
const ri = async () => (await rr()).length >= 10, ni = () => {
  const e = navigator.userAgent;
  return /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(e);
}, Ql = (e) => {
  const A = [];
  A.push(Vs({ img: $o, text: X().shake_sdk_dialog_add_attachment_grab_screenshot, onClick: yn })), ni() || A.push(Vs({ img: Ai, text: X().shake_sdk_dialog_add_attachment_record_screen, onClick: En }));
  ...
  return e.onclick = async (n) => {
    n.stopPropagation(), await ri() ? new ti(X().shake_sdk_dialog_attachment_limit_message, 4e3, X().shake_sdk_dialog_attachment_limit_title) : r();
  }, t;
...
}, si = "data:image/svg+xml,%3csvg%20width='31'%20height='32'%20viewBox='0%200%2031%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M12.7285%2013.4543L17.8197%2018.5455'%20stroke='%23F2F2F7'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M17.8197%2013.4545L12.7285%2018.5457'%20stroke='%23F2F2F7'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e", pl = (e) => {
  const A = L();
  ...
  return c.classList.add("shake-sdk-attachments-items"), e.forEach((B) => {
    const a = ((l, d, g) => {
      const u = tt(si);
      let w;
      u.classList.add("shake-sdk-attachment-remove"), u.onclick = (b) => {
        b.stopPropagation(), g(l);
      };
      const h = URL.createObjectURL(l.data);
      w = l.type == uA.IMAGE ? OA(h) : ur({ src: h + "#t=0.1", autoplay: !0 }), w.classList.add("shake-sdk-attachment-item-thumbnail");
      const p = mn();
      p.classList.add("shake-sdk-attachment-item-card"), p.appendChild(w), p.appendChild(u);
      const U = l.type == uA.IMAGE ? X().shake_sdk_dialog_add_attachment_type_image : X().shake_sdk_dialog_add_attachment_type_video, H = pl(U), F = L();
      F.classList.add("shake-sdk-attachment-item-title"), F.appendChild(H);
      const C = L();
      return C.classList.add("shake-sdk-attachment-item"), C.onclick = () => d(l), C.appendChild(p), C.appendChild(F), C;
    })(B, s, o);
    ...
    const a = L();
    return a.classList.add("shake-sdk-attachments-add-item"), a.appendChild(B), a.appendChild(Ql(B)), a;
  })()), i(), c;
}, fl = (e) => {
  const A = L();
  if (A.classList.add("shake-sdk-attachments-preview"), e) {
    const t = e.type == uA.IMAGE ? ((r) => {
      const n = URL.createObjectURL(r), s = OA(n), o = L();
      return o.classList.add("shake-sdk-image-preview"), o.appendChild(s), o;
    })(e.data) : ((r) => {
      const n = L();
      n.classList.add("shake-sdk-video-preview");
      const s = URL.createObjectURL(r), o = ur({ src: s + "#t=0.1", controls: !0 });
      return o.addEventListener("loadeddata", () => {
        n.appendChild(o);
      }, !1), n;
    })(e.data);
    A.appendChild(t);
  ...
  const r = (() => {
    const B = Vt();
    B.appendChild(OA(Ai)), B.appendChild(As(X().shake_sdk_dialog_add_attachment_record_screen)), B.onclick = En;
    const a = Vt();
    a.appendChild(OA($o)), a.appendChild(As(X().shake_sdk_dialog_add_attachment_grab_screenshot)), a.onclick = yn;
    const l = L();
  ...
  const o = () => {
    ...
    B ? (t.parentNode || o(), (a = B ?? "", new Promise((l, d) => {
      ...
      s.innerText = "", s.appendChild(fl(l));
    })) : r.parentNode || i();
  });
  ...
  document.body.appendChild(e);
}, ml = ({ label: e, items: A, onSelectionChange: t, selectedValue: r }) => {
  const n = L(), s = L();
...
})(X().shake_sdk_dialog_attachment_limit_title, X().shake_sdk_dialog_attachment_limit_message), ii = "data:image/svg+xml,%3csvg%20width='50'%20height='51'%20viewBox='0%200%2050%2051'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M20.834%2021.5598L29.1673%2029.8931'%20stroke='%23FFFFFF'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3cpath%20d='M29.1673%2021.56L20.834%2029.8933'%20stroke='%23FFFFFF'%20stroke-width='1.5'%20stroke-linecap='round'%20stroke-linejoin='round'/%3e%3c/svg%3e", El = (e) => {
  W(`Opening image: ${e.name}`), document.body.appendChild(((A) => {
    const t = $t({ image: ii, onClick: () => {
      c.remove();
    } }), r = L();
    r.classList.add("shake-sdk-image-preview-toolbar-fs"), r.appendChild(t);
    const n = URL.createObjectURL(A), s = OA(n);
    s.classList.add("shake-sdk-image-preview-fs");
    const o = L();
    o.classList.add("shake-sdk-image-preview-content-fs"), o.appendChild(s);
    const i = L();
    i.classList.add("shake-sdk-image-preview-root-fs"), i.appendChild(r), i.appendChild(o);
    const c = document.createElement("div"), B = c.attachShadow({ mode: "open" });
    return ue(B), B.appendChild(i), c;
  })(e.data));
}, bl = (e) => {
  W("Opening video: " + e.name), document.body.appendChild(((A) => {
    ...
    const n = URL.createObjectURL(A), s = ur({ src: n, controls: !0, autoplay: !0 });
    s.classList.add("shake-sdk-video-preview-fs");
    const o = L();
    o.classList.add("shake-sdk-video-preview-root-fs"), o.appendChild(r), o.appendChild(s);
  ...
  const A = iA.attachmentsManager, t = /* @__PURE__ */ new Map(), r = (i) => {
    i.type == uA.IMAGE ? El(i) : i.type == uA.VIDEO && bl(i);
  }, n = (i) => {
  ...
  s.classList.add("shake-sdk-attachments-items-small"), e.forEach((i) => {
    const c = ((B, a, l) => {
      const d = tt(si);
      let g;
      d.classList.add("shake-sdk-attachment-item-remove-small"), d.onclick = (h) => {
        h.stopPropagation(), l(B);
      };
      const u = URL.createObjectURL(B.data);
      g = B.type == uA.IMAGE ? OA(u) : ur({ src: u + "#t=0.1", autoplay: !0 }), g.classList.add("shake-sdk-attachment-item-thumbnail-small"), g.onclick = () => a(B);
      const w = L();
      return w.classList.add("shake-sdk-attachment-item-small"), w.appendChild(g), w.appendChild(d), w;
    })(i, r, n);
  ...
  const c = ((h = rt, p = !1, U = () => {
    ...
    const H = $t({ image: nn, onClick: () => U() }), F = $t({ image: nn, onClick: h }), C = document.createElement("div");
    return C.classList.add("shake-sdk-toolbar"), p && C.appendChild(H), C.appendChild(F), C;
  ...
  a.disabled = !0, a.onclick = async () => {
    s = !0, l(), await (async ({ feedbackType: h, description: p }) => {
      W("Ticket submitted.");
      const U = Se.shakeFeedbackService, H = iA.localStorage.getShakeState(), F = await rr(), C = H.ticket;
      C && (C.tags.push(h), C.custom_fields = kl(p, h), await U.sendUserFeedback(C, F)), ai(), rt();
    })({ feedbackType: t, description: r }), s = !1;
  };
  const d = io(X().shake_sdk_ticket_form_submit_button_text);
  a.appendChild(d);
  const g = ml({ label: X().shake_sdk_new_ticket_feedback_type_title, items: vl, onSelectionChange: (h) => {
    t = h, e.feedbackType = h, iA.localStorage.setShakeState(e);
  }, selectedValue: t });
  i.appendChild(c), i.appendChild(B), i.appendChild(g);
  const u = (({ onChange: h, maxLength: p, value: U, label: H }) => {
    const F = L();
    F.classList.add("shake-sdk-textarea-container");
    const C = document.createElement("label");
    C.textContent = H, C.classList.add("shake-sdk-textarea-label");
    const b = document.createElement("textarea");
    return b.classList.add("shake-sdk-textarea"), b.rows = 12, b.textContent = U || null, b.addEventListener("input", function(v) {
      let E = v.target.value;
      p && E.length > p && (E = E.slice(0, p), v.target.value = E), h(v.target.value);
    }), F.appendChild(C), F.appendChild(b), F;
  })({ onChange: (h) => {
...
xr = sn, Lr = sn.exports, function(e, A) {
  var t = "function", r = "undefined", n = "object", s = "string", o = "major", i = "model", c = "name", B = "type", a = "vendor", l = "version", d = "architecture", g = "console", u = "mobile", w = "tablet", h = "smarttv", p = "wearable", U = "embedded", H = "Amazon", F = "Apple", C = "ASUS", b = "BlackBerry", v = "Browser", E = "Chrome", _ = "Firefox", eA = "Google", gA = "Huawei", Y = "LG", tA = "Microsoft", sA = "Motorola", bA = "Opera", aA = "Samsung", pA = "Sharp", vA = "Sony", FA = "Xiaomi", IA = "Zebra", VA = "Facebook", PA = "Chromium OS", xA = "Mac OS", HA = function(O) {
    ...
    for (var I, rA, NA, R, zA, k, MA = 0; MA < V.length && !zA; ) {
      var ge = V[MA], XA = V[MA + 1];
      for (I = rA = 0; I < ge.length && !zA && ge[I]; )
        if (zA = ge[I++].exec(O))
    ...
    return this.getBrowser = function() {
      ...
      }(k[l]), zA && I && I.brave && typeof I.brave.isBrave == t && (k[c] = "Brave"), k;
    }, this.getCPU = function() {
      var k = {};
      return k[d] = A, D.call(k, rA, R.cpu), k;
    }, this.getDevice = function() {
      var k = {};
      return k[a] = A, k[i] = A, k[B] = A, D.call(k, rA, R.device), zA && !k[B] && NA && NA.mobile && (k[B] = u), zA && k[i] == "Macintosh" && I && typeof I.standalone !== r && I.maxTouchPoints && I.maxTouchPoints > 2 && (k[i] = "iPad", k[B] = w), k;
  ...
  j.VERSION = "1.0.37", j.BROWSER = HA([c, l, o]), j.CPU = HA([d]), j.DEVICE = HA([i, a, B, g, u, h, w, p, U]), j.ENGINE = j.OS = HA([c, l]), xr.exports && (Lr = xr.exports = j), Lr.UAParser = j;
...
}, Ol = () => "cookieEnabled" in navigator && navigator.cookieEnabled || null, Ml = () => {
  var e;
...
const li = async () => {
  ...
  Se.shakeAuthService.authenticate(yA.clientId, yA.clientSecret), Pl();
  const A = e.getShakeState();
  if (!A.ticket) {
    const n = await new Fn().captureScreenshot();
    n && await Zo(n), A.ticket = await Bi(), e.setShakeState(A);
  }
  const t = await rr(), r = ci(A, t);
  document.body.appendChild(r), e.setShakeOpened(!0);
}, Ar = "shake-sdk-main-button-root", Vl = () => {
    ...
    if (an.config.floatingButtonEnabled) {
      const e = (() => {
        ...
        r.classList.add("shake-sdk-main-button-text"), A.appendChild(t), A.appendChild(r), A.addEventListener("mousedown", (o) => {
          o.stopPropagation(), o.preventDefault(), li();
        });
        const n = document.createElement("div");
        n.id = Ar;
...
}, Ns = 5120, Nl = { takeScreenshot: !0, showSuccessMessage: !1 }, Xl = (e) => {
  const A = [];
  return e && A.push({ type: Rt.TITLE, value: e, label: "Title" }), A;
}, CA = class CA {
  static async start(A, t, r) {
    if (this.localStorage.getShakeDeviceId() || this.localStorage.setShakeDeviceId(hi()), !this.isLoading)
...
f(CA, "config", new _l()), f(CA, "isLoading", !1), f(CA, "localStorage", iA.localStorage), f(CA, "shakeAuthService", Se.shakeAuthService), f(CA, "show", async () => await CA.ifSDKEnabled(async () => {
  await li();
  ...
  await (async (r, n = Nl) => {
    ...
    const i = await Bi();
    i.tags.push("silent"), i.custom_fields = Xl(r), await s.sendUserFeedback(i, o), n.showSuccessMessage && ai();
  })(A, t);
